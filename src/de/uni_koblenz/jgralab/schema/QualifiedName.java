...
public class QualifiedName implements Comparable<QualifiedName> {
	...
	/**
	 * @return The unique name of this QualifiedName. This name is, as the qualifiedName is, unique in the
	 * whole schema but much shorter than the qualified one. For instance, if there is only one class
	 * with simple name "X" in the whole schema, the unique name of this class can also be "X" without the 
	 * package prefix
	 */
	...
	/**
	 * Sets the unique name of this QualifiedName. To ensure that the name is really unique in the whole schema,
	 * the element which should have this unique name needs to be specified. It there is any other element
