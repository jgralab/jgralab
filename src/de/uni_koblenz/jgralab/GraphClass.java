...
public interface GraphClass extends AttributedElementClass {
	 ...
	 */
	public EdgeClass createEdgeClass(String name, VertexClass from,
			VertexClass to) ;
	 ...
	 */
	public AggregationClass createAggregationClass(String name,
	 ...
	 */
	public CompositionClass createCompositionClass(String name,
	...
	/**
	 * adds superClass to the internal list of superclasses, all attributes get
	 * inherited from this superClass
	 * 
	 * @param superClass
	 *            a graph class
	 *
