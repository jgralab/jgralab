...
/**
 * basic class to create and change all kind of code segments offering the necessary
 * methods 
 * offers the possibilities to create code out of the stored Strings, store 
 * variables and their values, influence the relationship between different 
 * <code>CodeBlock</code>s and others  
 * 
...
public abstract class CodeBlock {
	/**
	 * a map storing variables of <code>this</code> with their corresponding values
	 */
	...
	/**
	 * stores the parental <code>CodeList</code> of this,
	 * if a circle is to be created, by (indirectly) setting <code>this</code> as
	 * its own <code>parent</code> a new <code>CodeList</code> with the old content
	 * will be the <code>parent</code> of <code>this</code>
	 * f.ex. if A is <code>parent</code> of B, B is <code>parent</code> of C, C is 
	 * about to be set as B´s <code>parent</code> than
	 * the <code>parent</code> of the <code>parent</code> of B, which is the
	 * <code>parent</code> of C, will be reset as the a <code>CodeList</code> 
	 * combining A and the old B
	 */
	 ...
	 * @param parent the <code>CodeList</code> that will be set as the parent of 
	 * <code>this</code>
	 */
	...
	/**
	 * 
	 * @param indentLevel defines how many tabulators are set in the beginning of 
	 * each line
	 ...
	 * @param map contains variables and their values
	 */
	 ...
	 * the stored <code>variables</code> a message of the form *UNDEFINED:name* 
	 * is returned
	 */
	...
	/**
	 * 
	 * @param line a String that possibly contains a variable
	 * @return the <code>line</code> where a variable starting and ending with # 
	 * are replaced by their values stored in the map <code>variables</code>, if
	 * no variable is part of <code>line</code> than line will returned unchanged
	 * @throws RuntimeException if an end marker (#) does not, as it is required, 
	 * follow the start marker (#) of <code>line</code>
	 */
	 ...
	 * @param newParent a <code>CodeList</code>
	 */
