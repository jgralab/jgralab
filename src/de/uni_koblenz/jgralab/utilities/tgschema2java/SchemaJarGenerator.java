...
public class SchemaJarGenerator {
     ...
     * 
     * @param pathToFiles the path to the directory where the files that should be
     *        part of the jar are located excluding the package name
     ...
     * @param packageName the name of the package the fiels are located in
     * @param jarFileName the name of the jar-file to create
     * @param compress toggles wether the contents of thew jar should be compressed
     *        or not
     */
