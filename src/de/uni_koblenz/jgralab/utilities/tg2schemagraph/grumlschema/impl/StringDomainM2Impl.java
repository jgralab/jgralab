...
public class StringDomainM2Impl extends VertexImpl implements BasicDomainM2, DomainM2, StringDomainM2, Vertex {

	public StringDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("StringDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return StringDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("StringDomainM2 doesn't contain an attribute " + attributeName);
	}
	...
	public StringDomainM2 getNextStringDomainM2() {
		return (StringDomainM2)getNextVertexOfClass(StringDomainM2.class);
	}

	public StringDomainM2 getNextStringDomainM2(boolean noSubClasses) {
		return (StringDomainM2)getNextVertexOfClass(StringDomainM2.class, noSubClasses);
	}
