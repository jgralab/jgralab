...
public class LongDomainM2Impl extends VertexImpl implements BasicDomainM2, DomainM2, LongDomainM2, Vertex {

	public LongDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("LongDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return LongDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("LongDomainM2 doesn't contain an attribute " + attributeName);
	}
	...
	public LongDomainM2 getNextLongDomainM2() {
		return (LongDomainM2)getNextVertexOfClass(LongDomainM2.class);
	}

	public LongDomainM2 getNextLongDomainM2(boolean noSubClasses) {
		return (LongDomainM2)getNextVertexOfClass(LongDomainM2.class, noSubClasses);
	}
