...
public class IntDomainM2Impl extends VertexImpl implements BasicDomainM2, DomainM2, IntDomainM2, Vertex {

	public IntDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("IntDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IntDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("IntDomainM2 doesn't contain an attribute " + attributeName);
	}
	...
	public IntDomainM2 getNextIntDomainM2() {
		return (IntDomainM2)getNextVertexOfClass(IntDomainM2.class);
	}

	public IntDomainM2 getNextIntDomainM2(boolean noSubClasses) {
		return (IntDomainM2)getNextVertexOfClass(IntDomainM2.class, noSubClasses);
	}
