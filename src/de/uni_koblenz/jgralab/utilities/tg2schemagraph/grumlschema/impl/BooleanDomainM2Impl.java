...
public class BooleanDomainM2Impl extends VertexImpl implements BasicDomainM2, BooleanDomainM2, DomainM2, Vertex {

	public BooleanDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("BooleanDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return BooleanDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("BooleanDomainM2 doesn't contain an attribute " + attributeName);
	}
	...
	public BooleanDomainM2 getNextBooleanDomainM2() {
		return (BooleanDomainM2)getNextVertexOfClass(BooleanDomainM2.class);
	}

	public BooleanDomainM2 getNextBooleanDomainM2(boolean noSubClasses) {
		return (BooleanDomainM2)getNextVertexOfClass(BooleanDomainM2.class, noSubClasses);
	}
