...
public class VertexClassM2Impl extends VertexImpl implements AttributedElementClassM2, GraphElementClassM2, Vertex, VertexClassM2 {

	protected boolean isAbstract;

	protected String name;

	public VertexClassM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("VertexClassM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return VertexClassM2.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("VertexClassM2 doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validFromEdges.add(IsSubVertexClassOfM2Impl.class);
	...
	
	{
		...
		validToEdges.add(FromM2Impl.class);

		validToEdges.add(ToM2Impl.class);

		validToEdges.add(HasAttributeM2Impl.class);

		validToEdges.add(IsSubVertexClassOfM2Impl.class);
	...
	public VertexClassM2 getNextVertexClassM2() {
		return (VertexClassM2)getNextVertexOfClass(VertexClassM2.class);
	}

	public VertexClassM2 getNextVertexClassM2(boolean noSubClasses) {
		return (VertexClassM2)getNextVertexOfClass(VertexClassM2.class, noSubClasses);
	}
	...
	public IsSubVertexClassOfM2 getFirstIsSubVertexClassOfM2() {
		return (IsSubVertexClassOfM2)getFirstEdgeOfClass(IsSubVertexClassOfM2.class);
	}

	public IsSubVertexClassOfM2 getFirstIsSubVertexClassOfM2(EdgeDirection orientation) {
		return (IsSubVertexClassOfM2)getFirstEdgeOfClass(IsSubVertexClassOfM2.class, orientation);
	}

	public IsSubVertexClassOfM2 getFirstIsSubVertexClassOfM2(boolean noSubClasses) {
		return (IsSubVertexClassOfM2)getFirstEdgeOfClass(IsSubVertexClassOfM2.class, noSubClasses);
	}

	public IsSubVertexClassOfM2 getFirstIsSubVertexClassOfM2(EdgeDirection orientation, boolean noSubClasses) {
		return (IsSubVertexClassOfM2)getFirstEdgeOfClass(IsSubVertexClassOfM2.class, orientation, noSubClasses);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsSubVertexClassOfM2, ? extends Vertex>> getIsSubVertexClassOfM2Incidences() {
		return new IncidenceIterable<IsSubVertexClassOfM2, Vertex>(this, IsSubVertexClassOfM2.class);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsSubVertexClassOfM2, ? extends Vertex>> getIsSubVertexClassOfM2Incidences(boolean noSubClasses) {
		return new IncidenceIterable<IsSubVertexClassOfM2, Vertex>(this, IsSubVertexClassOfM2.class, noSubClasses);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsSubVertexClassOfM2, ? extends Vertex>> getIsSubVertexClassOfM2Incidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsSubVertexClassOfM2, Vertex>(this, IsSubVertexClassOfM2.class, direction, noSubClasses);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsSubVertexClassOfM2, ? extends Vertex>> getIsSubVertexClassOfM2Incidences(EdgeDirection direction) {
		return new IncidenceIterable<IsSubVertexClassOfM2, Vertex>(this, IsSubVertexClassOfM2.class, direction);
	}
