...
public class ListDomainM2Impl extends VertexImpl implements CompositeDomainM2, DomainM2, ListDomainM2, Vertex {

	public ListDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("ListDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return ListDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("ListDomainM2 doesn't contain an attribute " + attributeName);
	}
	...
	public ListDomainM2 getNextListDomainM2() {
		return (ListDomainM2)getNextVertexOfClass(ListDomainM2.class);
	}

	public ListDomainM2 getNextListDomainM2(boolean noSubClasses) {
		return (ListDomainM2)getNextVertexOfClass(ListDomainM2.class, noSubClasses);
	}
