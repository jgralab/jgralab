...
public class DoubleDomainM2Impl extends VertexImpl implements BasicDomainM2, DomainM2, DoubleDomainM2, Vertex {

	public DoubleDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("DoubleDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return DoubleDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("DoubleDomainM2 doesn't contain an attribute " + attributeName);
	}
	...
	public DoubleDomainM2 getNextDoubleDomainM2() {
		return (DoubleDomainM2)getNextVertexOfClass(DoubleDomainM2.class);
	}

	public DoubleDomainM2 getNextDoubleDomainM2(boolean noSubClasses) {
		return (DoubleDomainM2)getNextVertexOfClass(DoubleDomainM2.class, noSubClasses);
	}
