...
public class EnumDomainM2Impl extends VertexImpl implements BasicDomainM2, DomainM2, EnumDomainM2, Vertex {

	protected java.util.List<String> constants;

	public EnumDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("EnumDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return EnumDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("constants")) return constants;
		throw new NoSuchFieldException("EnumDomainM2 doesn't contain an attribute " + attributeName);
	}

	@SuppressWarnings("unchecked")
	public void setAttribute(String attributeName, Object data) throws NoSuchFieldException {
		if (attributeName.equals("constants")) {
			setConstants((java.util.List<String>) data);
			return;
		}
		throw new NoSuchFieldException("EnumDomainM2 doesn't contain an attribute " + attributeName);
	}

	public java.util.List<String> getConstants() {
		return constants;
	}

	public void setConstants(java.util.List<String> constants) {
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		if (!io.isNextToken("\\null")) {
			constants = new java.util.ArrayList<String>();
			io.match("[");
			while (!io.isNextToken("]")) {
				String constantsElement;
				constantsElement = io.matchUtfString();
				constants.add(constantsElement);
			}
			io.match("]");
		} else {
			io.match("\\null");
	...
	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		...
		if (constants != null) {
			...
			io.write("[");
			io.noSpace();
			for (String constantsElement: constants) {
				io.writeUtfString(constantsElement);
			}
			io.write("]");
		} else {
			io.writeIdentifier("\\null");
	...
	public BasicDomainM2 getNextBasicDomainM2() {
		return (BasicDomainM2)getNextVertexOfClass(BasicDomainM2.class);
	}
	...
	public EnumDomainM2 getNextEnumDomainM2() {
		return (EnumDomainM2)getNextVertexOfClass(EnumDomainM2.class);
	}

	public EnumDomainM2 getNextEnumDomainM2(boolean noSubClasses) {
		return (EnumDomainM2)getNextVertexOfClass(EnumDomainM2.class, noSubClasses);
	}
