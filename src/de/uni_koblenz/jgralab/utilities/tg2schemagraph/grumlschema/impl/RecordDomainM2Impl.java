...
public class RecordDomainM2Impl extends VertexImpl implements CompositeDomainM2, DomainM2, RecordDomainM2, Vertex {

	protected String name;

	public RecordDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("RecordDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return RecordDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("name")) return name;
		throw new NoSuchFieldException("RecordDomainM2 doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validFromEdges.add(HasRecordDomainComponentM2Impl.class);
	...
	public RecordDomainM2 getNextRecordDomainM2() {
		return (RecordDomainM2)getNextVertexOfClass(RecordDomainM2.class);
	}

	public RecordDomainM2 getNextRecordDomainM2(boolean noSubClasses) {
		return (RecordDomainM2)getNextVertexOfClass(RecordDomainM2.class, noSubClasses);
	}
