...
public class EdgeClassM2Impl extends VertexImpl implements AttributedElementClassM2, EdgeClassM2, GraphElementClassM2, Vertex {

	protected boolean isAbstract;

	protected String name;

	public EdgeClassM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("EdgeClassM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return EdgeClassM2.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("EdgeClassM2 doesn't contain an attribute " + attributeName);
	}
