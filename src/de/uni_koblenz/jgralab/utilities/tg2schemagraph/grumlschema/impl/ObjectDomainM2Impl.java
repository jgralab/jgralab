...
public class ObjectDomainM2Impl extends VertexImpl implements BasicDomainM2, DomainM2, ObjectDomainM2, Vertex {

	public ObjectDomainM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("ObjectDomainM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return ObjectDomainM2.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("ObjectDomainM2 doesn't contain an attribute " + attributeName);
	}
	...
	public ObjectDomainM2 getNextObjectDomainM2() {
		return (ObjectDomainM2)getNextVertexOfClass(ObjectDomainM2.class);
	}

	public ObjectDomainM2 getNextObjectDomainM2(boolean noSubClasses) {
		return (ObjectDomainM2)getNextVertexOfClass(ObjectDomainM2.class, noSubClasses);
	}
