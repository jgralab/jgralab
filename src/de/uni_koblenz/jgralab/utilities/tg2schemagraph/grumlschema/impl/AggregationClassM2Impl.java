...
public class AggregationClassM2Impl extends VertexImpl implements AggregationClassM2, AttributedElementClassM2, EdgeClassM2, GraphElementClassM2, Vertex {
	...
	public AggregationClassM2Impl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("AggregationClassM2"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return AggregationClassM2.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("AggregationClassM2 doesn't contain an attribute " + attributeName);
	}
