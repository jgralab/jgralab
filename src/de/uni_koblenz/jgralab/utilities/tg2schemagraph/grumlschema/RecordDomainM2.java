...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.RecordDomainM2Impl;

public interface RecordDomainM2 extends CompositeDomainM2, DomainM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<RecordDomainM2Impl> IMPLEMENTATION_CLASS = RecordDomainM2Impl.class;
	...
	/**
	 * @return the next RecordDomainM2 vertex in the global vertex sequence
	 */
