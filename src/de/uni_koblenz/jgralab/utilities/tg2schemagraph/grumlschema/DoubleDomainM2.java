...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.DoubleDomainM2Impl;

public interface DoubleDomainM2 extends BasicDomainM2, DomainM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<DoubleDomainM2Impl> IMPLEMENTATION_CLASS = DoubleDomainM2Impl.class;
	...
	/**
	 * @return the next DoubleDomainM2 vertex in the global vertex sequence
	 */
