...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.EnumDomainM2Impl;

public interface EnumDomainM2 extends BasicDomainM2, DomainM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<EnumDomainM2Impl> IMPLEMENTATION_CLASS = EnumDomainM2Impl.class;
	...
	/**
	 * @return the next EnumDomainM2 vertex in the global vertex sequence
	 */
