...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.ListDomainM2Impl;

public interface ListDomainM2 extends CompositeDomainM2, DomainM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<ListDomainM2Impl> IMPLEMENTATION_CLASS = ListDomainM2Impl.class;
	...
	/**
	 * @return the next ListDomainM2 vertex in the global vertex sequence
	 */
