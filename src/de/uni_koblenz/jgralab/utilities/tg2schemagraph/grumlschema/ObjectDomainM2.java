...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.ObjectDomainM2Impl;

public interface ObjectDomainM2 extends BasicDomainM2, DomainM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<ObjectDomainM2Impl> IMPLEMENTATION_CLASS = ObjectDomainM2Impl.class;
	...
	/**
	 * @return the next ObjectDomainM2 vertex in the global vertex sequence
	 */
