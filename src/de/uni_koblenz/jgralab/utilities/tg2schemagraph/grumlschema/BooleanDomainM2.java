...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.BooleanDomainM2Impl;

public interface BooleanDomainM2 extends BasicDomainM2, DomainM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<BooleanDomainM2Impl> IMPLEMENTATION_CLASS = BooleanDomainM2Impl.class;
	...
	/**
	 * @return the next BooleanDomainM2 vertex in the global vertex sequence
	 */
