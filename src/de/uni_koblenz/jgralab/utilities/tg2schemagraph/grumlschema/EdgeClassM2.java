...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.EdgeClassM2Impl;

public interface EdgeClassM2 extends AttributedElementClassM2, GraphElementClassM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<EdgeClassM2Impl> IMPLEMENTATION_CLASS = EdgeClassM2Impl.class;
	...
	/**
	 * Returns an iterable for all incidence edges of this vertex that are of type IsSubEdgeClassOfM2 or subtypes
	 */
