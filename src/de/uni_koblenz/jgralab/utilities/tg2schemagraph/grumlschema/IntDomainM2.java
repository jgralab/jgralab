...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.IntDomainM2Impl;

public interface IntDomainM2 extends BasicDomainM2, DomainM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<IntDomainM2Impl> IMPLEMENTATION_CLASS = IntDomainM2Impl.class;
	...
	/**
	 * @return the next IntDomainM2 vertex in the global vertex sequence
	 */
