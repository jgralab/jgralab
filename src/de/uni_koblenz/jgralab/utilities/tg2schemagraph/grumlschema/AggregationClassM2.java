...
import de.uni_koblenz.jgralab.utilities.tg2schemagraph.grumlschema.impl.AggregationClassM2Impl;

public interface AggregationClassM2 extends AttributedElementClassM2, EdgeClassM2, GraphElementClassM2, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<AggregationClassM2Impl> IMPLEMENTATION_CLASS = AggregationClassM2Impl.class;
