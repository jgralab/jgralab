 ...
 */
public class ElementDefinition extends AbstractDefinition implements Cloneable {
    ...
    /**
     * Clones an ElementDefinition by initializing all data structures and copying
     * all references.
     * 
     * @param definition ElementDefinition, which is cloned.
     */
    ...
    /**
     * Determines whether or not the given {@link AttributedElement} is included in
     * this ElementDefinition.
     * 
     * @param element AttributedElement in question.
     ...
     * 
     * @param element {@link AttributedElement} to be added.
     */
