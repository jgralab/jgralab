 ...
 */
public interface Definition extends Cloneable {
    ...
    /**
     * Sets a attribute with the given name and value. This method will overwrite
     * any pre-existing attribute with the same attribute name.
     *
     * @param name Name of the attribute.
     ...
     * given Definition.
     *
     * @param definition Definition with additional or even more important
     *        attributes.
     */
     ...
     * definition.
     *
     * @param definition Definition with additional but less important attributes.
     */
    public void addNonExistingAttributes(Definition definition);

    /**
     * Will return a clone of the current definition. All data structures are clones
     * but not their stores elements are only referenced.
     *
