...
public enum TokenTypes {
	...
	T, AND, FALSE, NOT, UNDEFINED, OR, TRUE, XOR, AS, MAP, E, ESUBGRAPH,

	EXISTS_ONE, EXISTS, END, FORALL, FROM, IN, LET, LIST, REC, REPORT, REPORTSET,

	REPORTLIST, REPORTTABLE, REPORTMAP, STORE, SET, TUP, USING, V, VSUBGRAPH,
