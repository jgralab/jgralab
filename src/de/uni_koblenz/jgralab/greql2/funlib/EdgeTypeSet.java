 ...
 * <dd><code>c</code> - collection to return edge-types for</dd>
 * <dd><code>p</code> - path to return edge-types for</dd>
 * <dd><code>ps</code> - path system to return edge-types for</dd>
 * <dt><b>Returns:</b></dt>
 * <dd>a set of all edge-types that occure in the given structure</dd>
 * </dl>
 * </dd>
 * </dl>
 * 
