...
public abstract class Function {
	...
	public enum Category {
		UNDEFINED, DEBUGGING, LOGICS, RELATIONS, ARITHMETICS,

		STATISTICS, STRINGS, COLLECTIONS_AND_MAPS, PATHS_AND_PATHSYSTEMS_AND_SLICES,

		SCHEMA_ACCESS, GRAPH, REFLECTION
	}
