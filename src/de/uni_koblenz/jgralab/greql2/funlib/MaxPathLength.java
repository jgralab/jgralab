 ...
 * <dd><code>INT maxPathLenght(ps:PATHSYSTEM)</code></dd>
 * <dd>&nbsp;</dd>
 * </dl>
 * <dl>
 * <dt></dt>
 ...
 * <dd><code>ps</code> - pathsystem to calculate the length of the longest path
 * for</dd>
 * <dt><b>Returns:</b></dt>
...
public class MaxPathLength extends Greql2Function {
	{
	...
	public JValue evaluate(Graph graph, AbstractGraphMarker<?> subgraph,
		...
		return new JValueImpl(arguments[0].toPathSystem().maxPathLength());
	}
