...
public class Vertices extends Function {
	...
	@Description(params = "p", description = "Returns the set of vertices in the given path system.",
			categories = Category.PATHS_AND_PATHSYSTEMS_AND_SLICES)
	public PSet<Vertex> evaluate(PathSystem p) {
		return p.getVertices();
	}

	@Description(params = "s", description = "Returns the set of vertices in the given slice.",
			categories = Category.PATHS_AND_PATHSYSTEMS_AND_SLICES)
