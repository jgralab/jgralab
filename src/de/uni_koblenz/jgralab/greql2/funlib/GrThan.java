 ...
 * <dd><code>BOOLEAN grThan(a: INTEGER, b: LONG)</code></dd>
 * <dd><code>BOOLEAN grThan(a: INTEGER, b: DOUBLE)</code></dd>
 * <dd><code>BOOLEAN grThan(a: LONG, b: INTEGER)</code></dd>
 * <dd><code>BOOLEAN grThan(a: LONG, b: LONG)</code></dd>
 * <dd><code>BOOLEAN grThan(a: LONG, b: DOUBLE)</code></dd>
 * <dd><code>BOOLEAN grThan(a: DOUBLE, b: INTEGER)</code></dd>
 * <dd><code>BOOLEAN grThan(a: DOUBLE, b: LONG)</code></dd>
 * <dd><code>BOOLEAN grThan(a: DOUBLE, b: DOUBLE)</code></dd>
 * <dd><code>BOOLEAN grThan(s1: STRING, s2: STRING)</code></dd>
 * <dd>&nbsp;</dd>
