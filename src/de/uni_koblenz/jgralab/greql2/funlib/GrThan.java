 ...
 * <dd><code>BOOL grThan(a: INT, b: INT)</code></dd>
 * <dd><code>BOOL grThan(a: INT, b: LONG)</code></dd>
 * <dd><code>BOOL grThan(a: INT, b: DOUBLE)</code></dd>
 * <dd><code>BOOL grThan(a: LONG, b: INT)</code></dd>
 * <dd><code>BOOL grThan(a: LONG, b: LONG)</code></dd>
 * <dd><code>BOOL grThan(a: LONG, b: DOUBLE)</code></dd>
 * <dd><code>BOOL grThan(a: DOUBLE, b: INT)</code></dd>
 * <dd><code>BOOL grThan(a: DOUBLE, b: LONG)</code></dd>
 * <dd><code>BOOL grThan(a: DOUBLE, b: DOUBLE)</code></dd>
 * <dd><code>BOOL grThan(s1: STRING, s2: STRING)</code></dd>
 * <dd>&nbsp;</dd>
