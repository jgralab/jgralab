...
public class GraphIndex {
	...
	/**
	 * the size of this graphindex, counted in vertices/edges. 
	 * So, if the index contains 1 million vertices and two million edges,
	 * the size of the index is three million. 
	 */
	 ...
	 * @param graph the graph to create the Index for
	 */
	 ...
	 * @param query the query which constructs this set, e.g. "V{Identifier}"
	 */
	...
	/**
	 * returns the indexed vertex set for the given query part or <code>null</code> if no indexed vertex set exists 
	 */
	...
	/**
	 * removes as much entrys as are needed to push the index size below the given value in graph elements
	 * @param maxIndexSize the method will remove as much indix entrys as needed to get the index size lower than maxIndexSize, measured in GraphElements
	 */
