...
import de.uni_koblenz.jgralab.greql2.schema.impl.BagComprehensionImpl;

public interface BagComprehension extends Comprehension, ComprehensionWithTableHeader, Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<BagComprehensionImpl> IMPLEMENTATION_CLASS = BagComprehensionImpl.class;

	/**
	 * @return the next BagComprehension vertex in the global vertex sequence
	 */
