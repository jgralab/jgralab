...
import de.uni_koblenz.jgralab.greql2.schema.impl.VariableImpl;

public interface Variable extends Expression, Greql2Vertex, Identifier, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<VariableImpl> IMPLEMENTATION_CLASS = VariableImpl.class;
	...
	/**
	 * @return the next Variable vertex in the global vertex sequence
	 */
