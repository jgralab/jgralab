...
import de.uni_koblenz.jgralab.greql2.schema.impl.BackwardVertexSetImpl;

public interface BackwardVertexSet extends Expression, Greql2Vertex, PathExpression, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<BackwardVertexSetImpl> IMPLEMENTATION_CLASS = BackwardVertexSetImpl.class;

	/**
	 * @return the next BackwardVertexSet vertex in the global vertex sequence
	 */
	...
	/**
	 * @return the next PathExpression vertex in the global vertex sequence
	 */
