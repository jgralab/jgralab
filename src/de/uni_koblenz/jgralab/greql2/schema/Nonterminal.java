...
import de.uni_koblenz.jgralab.greql2.schema.impl.NonterminalImpl;

public interface Nonterminal extends Expression, Greql2Vertex, Identifier, Symbol, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<NonterminalImpl> IMPLEMENTATION_CLASS = NonterminalImpl.class;
	...
	/**
	 * @return the next Nonterminal vertex in the global vertex sequence
	 */
	...
	/**
	 * @return the next Symbol vertex in the global vertex sequence
	 */
