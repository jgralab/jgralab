...
import de.uni_koblenz.jgralab.greql2.schema.impl.LiteralImpl;

public interface Literal extends Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<LiteralImpl> IMPLEMENTATION_CLASS = LiteralImpl.class;
