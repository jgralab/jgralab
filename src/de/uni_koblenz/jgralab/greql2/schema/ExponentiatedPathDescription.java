...
import de.uni_koblenz.jgralab.greql2.schema.impl.ExponentiatedPathDescriptionImpl;

public interface ExponentiatedPathDescription extends Expression, Greql2Vertex, PathDescription, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<ExponentiatedPathDescriptionImpl> IMPLEMENTATION_CLASS = ExponentiatedPathDescriptionImpl.class;

	/**
	 * @return the next ExponentiatedPathDescription vertex in the global vertex sequence
	 */
