...
import de.uni_koblenz.jgralab.greql2.schema.impl.BoolLiteralImpl;

public interface BoolLiteral extends Expression, Greql2Vertex, Literal, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<BoolLiteralImpl> IMPLEMENTATION_CLASS = BoolLiteralImpl.class;
	...
	/**
	 * @return the next BoolLiteral vertex in the global vertex sequence
	 */
