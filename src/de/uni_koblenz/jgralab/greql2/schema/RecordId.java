...
import de.uni_koblenz.jgralab.greql2.schema.impl.RecordIdImpl;

public interface RecordId extends Expression, Greql2Vertex, Identifier, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<RecordIdImpl> IMPLEMENTATION_CLASS = RecordIdImpl.class;
	...
	/**
	 * @return the next RecordId vertex in the global vertex sequence
	 */
