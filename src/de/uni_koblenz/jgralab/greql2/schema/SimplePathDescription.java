...
import de.uni_koblenz.jgralab.greql2.schema.impl.SimplePathDescriptionImpl;

public interface SimplePathDescription extends Expression, Greql2Vertex, PathDescription, PrimaryPathDescription, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<SimplePathDescriptionImpl> IMPLEMENTATION_CLASS = SimplePathDescriptionImpl.class;
	...
	/**
	 * @return the next PrimaryPathDescription vertex in the global vertex sequence
	 */
	public PrimaryPathDescription getNextPrimaryPathDescription();

	/**
	 * @return the next SimplePathDescription vertex in the global vertex sequence
	 */
