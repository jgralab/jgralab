...
import de.uni_koblenz.jgralab.greql2.schema.impl.IntLiteralImpl;

public interface IntLiteral extends Expression, Greql2Vertex, Literal, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<IntLiteralImpl> IMPLEMENTATION_CLASS = IntLiteralImpl.class;
	...
	/**
	 * @return the next IntLiteral vertex in the global vertex sequence
	 */
	...
	/**
	 * @return the next Literal vertex in the global vertex sequence
	 */
