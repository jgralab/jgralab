...
import de.uni_koblenz.jgralab.greql2.schema.impl.VertexSubgraphExpressionImpl;

public interface VertexSubgraphExpression extends Expression, Greql2Vertex, SubgraphExpression, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<VertexSubgraphExpressionImpl> IMPLEMENTATION_CLASS = VertexSubgraphExpressionImpl.class;
	...
	/**
	 * @return the next SubgraphExpression vertex in the global vertex sequence
	 */
	public SubgraphExpression getNextSubgraphExpression();

	/**
	 * @return the next VertexSubgraphExpression vertex in the global vertex sequence
	 */
