...
import de.uni_koblenz.jgralab.greql2.schema.impl.AlternativePathDescriptionImpl;

public interface AlternativePathDescription extends Expression, Greql2Vertex, PathDescription, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<AlternativePathDescriptionImpl> IMPLEMENTATION_CLASS = AlternativePathDescriptionImpl.class;

	/**
	 * @return the next AlternativePathDescription vertex in the global vertex sequence
	 */
