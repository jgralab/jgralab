...
import de.uni_koblenz.jgralab.greql2.schema.impl.CfGrammarImpl;

public interface CfGrammar extends Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<CfGrammarImpl> IMPLEMENTATION_CLASS = CfGrammarImpl.class;

	/**
	 * @return the next CfGrammar vertex in the global vertex sequence
	 */
