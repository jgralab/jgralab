...
import de.uni_koblenz.jgralab.greql2.schema.impl.AttributeIdImpl;

public interface AttributeId extends Expression, Greql2Vertex, Identifier, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<AttributeIdImpl> IMPLEMENTATION_CLASS = AttributeIdImpl.class;

	/**
	 * @return the next AttributeId vertex in the global vertex sequence
	 */
