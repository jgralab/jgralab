...
import de.uni_koblenz.jgralab.greql2.schema.impl.RoleIdImpl;

public interface RoleId extends Expression, Greql2Vertex, Identifier, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<RoleIdImpl> IMPLEMENTATION_CLASS = RoleIdImpl.class;
	...
	/**
	 * @return the next RoleId vertex in the global vertex sequence
	 */
