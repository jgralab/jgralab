...
import de.uni_koblenz.jgralab.greql2.schema.impl.TypeIdImpl;

public interface TypeId extends Expression, Greql2Vertex, Identifier, Symbol, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<TypeIdImpl> IMPLEMENTATION_CLASS = TypeIdImpl.class;
	...
	/**
	 * @return the next TypeId vertex in the global vertex sequence
	 */
