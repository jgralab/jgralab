...
import de.uni_koblenz.jgralab.greql2.schema.impl.ThisLiteralImpl;

public interface ThisLiteral extends Expression, Greql2Vertex, Literal, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<ThisLiteralImpl> IMPLEMENTATION_CLASS = ThisLiteralImpl.class;
	...
	/**
	 * @return the next ThisLiteral vertex in the global vertex sequence
	 */
