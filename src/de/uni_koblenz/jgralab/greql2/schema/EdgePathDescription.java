...
import de.uni_koblenz.jgralab.greql2.schema.impl.EdgePathDescriptionImpl;

public interface EdgePathDescription extends Expression, Greql2Vertex, PathDescription, PrimaryPathDescription, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<EdgePathDescriptionImpl> IMPLEMENTATION_CLASS = EdgePathDescriptionImpl.class;

	/**
	 * @return the next EdgePathDescription vertex in the global vertex sequence
	 */
