...
import de.uni_koblenz.jgralab.greql2.schema.impl.WhereExpressionImpl;

public interface WhereExpression extends DefinitionExpression, Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<WhereExpressionImpl> IMPLEMENTATION_CLASS = WhereExpressionImpl.class;
	...
	/**
	 * @return the next WhereExpression vertex in the global vertex sequence
	 */
