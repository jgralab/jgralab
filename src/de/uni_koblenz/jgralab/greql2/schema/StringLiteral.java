...
import de.uni_koblenz.jgralab.greql2.schema.impl.StringLiteralImpl;

public interface StringLiteral extends Expression, Greql2Vertex, Literal, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<StringLiteralImpl> IMPLEMENTATION_CLASS = StringLiteralImpl.class;
	...
	/**
	 * @return the next StringLiteral vertex in the global vertex sequence
	 */
