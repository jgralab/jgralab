...
import de.uni_koblenz.jgralab.greql2.schema.impl.RestrictedExpressionImpl;

public interface RestrictedExpression extends Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<RestrictedExpressionImpl> IMPLEMENTATION_CLASS = RestrictedExpressionImpl.class;
	...
	/**
	 * @return the next RestrictedExpression vertex in the global vertex sequence
	 */
