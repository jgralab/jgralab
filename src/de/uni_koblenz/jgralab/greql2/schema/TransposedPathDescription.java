...
import de.uni_koblenz.jgralab.greql2.schema.impl.TransposedPathDescriptionImpl;

public interface TransposedPathDescription extends Expression, Greql2Vertex, PathDescription, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<TransposedPathDescriptionImpl> IMPLEMENTATION_CLASS = TransposedPathDescriptionImpl.class;
	...
	/**
	 * @return the next TransposedPathDescription vertex in the global vertex sequence
	 */
