...
import de.uni_koblenz.jgralab.greql2.schema.impl.BagConstructionImpl;

public interface BagConstruction extends Expression, Greql2Vertex, ValueConstruction, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<BagConstructionImpl> IMPLEMENTATION_CLASS = BagConstructionImpl.class;

	/**
	 * @return the next BagConstruction vertex in the global vertex sequence
	 */
