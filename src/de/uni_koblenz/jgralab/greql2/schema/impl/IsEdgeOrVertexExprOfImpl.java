...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsEdgeOrVertexExprOfImpl;
...
public class IsEdgeOrVertexExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsEdgeOrVertexExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsEdgeOrVertexExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsEdgeOrVertexExprOf"));
		reversedEdge = new ReversedIsEdgeOrVertexExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsEdgeOrVertexExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsEdgeOrVertexExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsEdgeOrVertexExprOf getNextIsEdgeOrVertexExprOfInGraph() {
		return (IsEdgeOrVertexExprOf)getNextEdgeOfClassInGraph(IsEdgeOrVertexExprOf.class);
	}

	public IsEdgeOrVertexExprOf getNextIsEdgeOrVertexExprOfInGraph(boolean noSubClasses) {
		return (IsEdgeOrVertexExprOf)getNextEdgeOfClassInGraph(IsEdgeOrVertexExprOf.class, noSubClasses);
	}
