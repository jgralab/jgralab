...
public class PathConstructionImpl extends VertexImpl implements Expression, Greql2Vertex, PathConstruction, ValueConstruction, Vertex {

	public PathConstructionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("PathConstruction"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return PathConstruction.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("PathConstruction doesn't contain an attribute " + attributeName);
	}
	...
	public PathConstruction getNextPathConstruction() {
		return (PathConstruction)getNextVertexOfClass(PathConstruction.class);
	}

	public PathConstruction getNextPathConstruction(boolean noSubClasses) {
		return (PathConstruction)getNextVertexOfClass(PathConstruction.class, noSubClasses);
	}
