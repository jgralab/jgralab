...
public class LetExpressionImpl extends VertexImpl implements DefinitionExpression, Expression, Greql2Vertex, LetExpression, Vertex {

	public LetExpressionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("LetExpression"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("LetExpression doesn't contain an attribute " + attributeName);
	}
	...
	public LetExpression getNextLetExpression() {
		return (LetExpression)getNextVertexOfClass(LetExpression.class);
	}

	public LetExpression getNextLetExpression(boolean noSubClasses) {
		return (LetExpression)getNextVertexOfClass(LetExpression.class, noSubClasses);
	}
