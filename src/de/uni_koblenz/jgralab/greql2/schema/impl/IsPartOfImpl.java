...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsPartOfImpl;
...
public class IsPartOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsPartOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsPartOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsPartOf"));
		reversedEdge = new ReversedIsPartOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsPartOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsPartOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsPartOf getNextIsPartOfInGraph() {
		return (IsPartOf)getNextEdgeOfClassInGraph(IsPartOf.class);
	}

	public IsPartOf getNextIsPartOfInGraph(boolean noSubClasses) {
		return (IsPartOf)getNextEdgeOfClassInGraph(IsPartOf.class, noSubClasses);
	}
