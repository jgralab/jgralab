...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsQuantifiedDeclOfImpl;
...
public class IsQuantifiedDeclOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsQuantifiedDeclOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsQuantifiedDeclOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsQuantifiedDeclOf"));
		reversedEdge = new ReversedIsQuantifiedDeclOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsQuantifiedDeclOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsQuantifiedDeclOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsQuantifiedDeclOf getNextIsQuantifiedDeclOfInGraph() {
		return (IsQuantifiedDeclOf)getNextEdgeOfClassInGraph(IsQuantifiedDeclOf.class);
	}

	public IsQuantifiedDeclOf getNextIsQuantifiedDeclOfInGraph(boolean noSubClasses) {
		return (IsQuantifiedDeclOf)getNextEdgeOfClassInGraph(IsQuantifiedDeclOf.class, noSubClasses);
	}
