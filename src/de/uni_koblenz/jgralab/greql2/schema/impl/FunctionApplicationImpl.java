...
public class FunctionApplicationImpl extends VertexImpl implements Expression, FunctionApplication, Greql2Vertex, Vertex {

	public FunctionApplicationImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("FunctionApplication"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return FunctionApplication.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("FunctionApplication doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsFunctionIdOfImpl.class);

		validToEdges.add(IsTypeExprOfFunctionImpl.class);

		validToEdges.add(IsArgumentOfImpl.class);
	...
	public FunctionApplication getNextFunctionApplication() {
		return (FunctionApplication)getNextVertexOfClass(FunctionApplication.class);
	}

	public FunctionApplication getNextFunctionApplication(boolean noSubClasses) {
		return (FunctionApplication)getNextVertexOfClass(FunctionApplication.class, noSubClasses);
	}
	...
	public IsFunctionIdOf getFirstIsFunctionIdOf() {
		return (IsFunctionIdOf)getFirstEdgeOfClass(IsFunctionIdOf.class);
	}

	public IsFunctionIdOf getFirstIsFunctionIdOf(EdgeDirection orientation) {
		return (IsFunctionIdOf)getFirstEdgeOfClass(IsFunctionIdOf.class, orientation);
	}

	public IsFunctionIdOf getFirstIsFunctionIdOf(boolean noSubClasses) {
		return (IsFunctionIdOf)getFirstEdgeOfClass(IsFunctionIdOf.class, noSubClasses);
	}

	public IsFunctionIdOf getFirstIsFunctionIdOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsFunctionIdOf)getFirstEdgeOfClass(IsFunctionIdOf.class, orientation, noSubClasses);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsFunctionIdOf, ? extends Vertex>> getIsFunctionIdOfIncidences() {
		return new IncidenceIterable<IsFunctionIdOf, Vertex>(this, IsFunctionIdOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsFunctionIdOf, ? extends Vertex>> getIsFunctionIdOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsFunctionIdOf, Vertex>(this, IsFunctionIdOf.class, noSubClasses);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsFunctionIdOf, ? extends Vertex>> getIsFunctionIdOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsFunctionIdOf, Vertex>(this, IsFunctionIdOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsFunctionIdOf, ? extends Vertex>> getIsFunctionIdOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsFunctionIdOf, Vertex>(this, IsFunctionIdOf.class, direction);
	}
