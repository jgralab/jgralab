...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsRowHeaderExprOfImpl;
...
public class IsRowHeaderExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsRowHeaderExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsRowHeaderExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsRowHeaderExprOf"));
		reversedEdge = new ReversedIsRowHeaderExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsRowHeaderExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsRowHeaderExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsRowHeaderExprOf getNextIsRowHeaderExprOfInGraph() {
		return (IsRowHeaderExprOf)getNextEdgeOfClassInGraph(IsRowHeaderExprOf.class);
	}

	public IsRowHeaderExprOf getNextIsRowHeaderExprOfInGraph(boolean noSubClasses) {
		return (IsRowHeaderExprOf)getNextEdgeOfClassInGraph(IsRowHeaderExprOf.class, noSubClasses);
	}
