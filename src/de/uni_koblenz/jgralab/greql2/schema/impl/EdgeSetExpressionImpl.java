...
public class EdgeSetExpressionImpl extends VertexImpl implements EdgeSetExpression, ElementSetExpression, Expression, Greql2Vertex, Vertex {

	public EdgeSetExpressionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("EdgeSetExpression"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return EdgeSetExpression.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("EdgeSetExpression doesn't contain an attribute " + attributeName);
	}
	...
	public EdgeSetExpression getNextEdgeSetExpression() {
		return (EdgeSetExpression)getNextVertexOfClass(EdgeSetExpression.class);
	}

	public EdgeSetExpression getNextEdgeSetExpression(boolean noSubClasses) {
		return (EdgeSetExpression)getNextVertexOfClass(EdgeSetExpression.class, noSubClasses);
	}
