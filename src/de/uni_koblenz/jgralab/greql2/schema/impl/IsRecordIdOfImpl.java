...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsRecordIdOfImpl;
...
public class IsRecordIdOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsRecordIdOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsRecordIdOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsRecordIdOf"));
		reversedEdge = new ReversedIsRecordIdOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsRecordIdOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsRecordIdOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsRecordIdOf getNextIsRecordIdOfInGraph() {
		return (IsRecordIdOf)getNextEdgeOfClassInGraph(IsRecordIdOf.class);
	}

	public IsRecordIdOf getNextIsRecordIdOfInGraph(boolean noSubClasses) {
		return (IsRecordIdOf)getNextEdgeOfClassInGraph(IsRecordIdOf.class, noSubClasses);
	}
	...
	public IsRecordIdOf getNextIsRecordIdOf() {
		return (IsRecordIdOf)getNextEdgeOfClass(IsRecordIdOf.class);
	}

	public IsRecordIdOf getNextIsRecordIdOf(EdgeDirection orientation) {
		return (IsRecordIdOf)getNextEdgeOfClass(IsRecordIdOf.class, orientation);
	}

	public IsRecordIdOf getNextIsRecordIdOf(boolean noSubClasses) {
		return (IsRecordIdOf)getNextEdgeOfClass(IsRecordIdOf.class, noSubClasses);
	}

	public IsRecordIdOf getNextIsRecordIdOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsRecordIdOf)getNextEdgeOfClass(IsRecordIdOf.class, orientation, noSubClasses);
	}
