...
public class RestrictedExpressionImpl extends VertexImpl implements Expression, Greql2Vertex, RestrictedExpression, Vertex {

	public RestrictedExpressionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("RestrictedExpression"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return RestrictedExpression.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("RestrictedExpression doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsRestrictedExprOfImpl.class);

		validToEdges.add(IsRestrictionOfImpl.class);
	...
	public RestrictedExpression getNextRestrictedExpression() {
		return (RestrictedExpression)getNextVertexOfClass(RestrictedExpression.class);
	}

	public RestrictedExpression getNextRestrictedExpression(boolean noSubClasses) {
		return (RestrictedExpression)getNextVertexOfClass(RestrictedExpression.class, noSubClasses);
	}
