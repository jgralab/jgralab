...
public class IteratedPathDescriptionImpl extends VertexImpl implements Expression, Greql2Vertex, IteratedPathDescription, PathDescription, Vertex {

	protected String times;

	public IteratedPathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("IteratedPathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IteratedPathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("times")) return times;
		throw new NoSuchFieldException("IteratedPathDescription doesn't contain an attribute " + attributeName);
	}

	@SuppressWarnings("unchecked")
	public void setAttribute(String attributeName, Object data) throws NoSuchFieldException {
		if (attributeName.equals("times")) {
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		times = io.matchUtfString();
		setTimes(times);
	}

	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		io.space();
		io.writeUtfString(times);
	}
	...
	
	{
		...
		validToEdges.add(IsIteratedPathOfImpl.class);
	...
	public IteratedPathDescription getNextIteratedPathDescription() {
		return (IteratedPathDescription)getNextVertexOfClass(IteratedPathDescription.class);
	}

	public IteratedPathDescription getNextIteratedPathDescription(boolean noSubClasses) {
		return (IteratedPathDescription)getNextVertexOfClass(IteratedPathDescription.class, noSubClasses);
	}
