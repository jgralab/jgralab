...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsTargetExprOfImpl;
...
public class IsTargetExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsTargetExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsTargetExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsTargetExprOf"));
		reversedEdge = new ReversedIsTargetExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsTargetExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsTargetExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsTargetExprOf getNextIsTargetExprOfInGraph() {
		return (IsTargetExprOf)getNextEdgeOfClassInGraph(IsTargetExprOf.class);
	}

	public IsTargetExprOf getNextIsTargetExprOfInGraph(boolean noSubClasses) {
		return (IsTargetExprOf)getNextEdgeOfClassInGraph(IsTargetExprOf.class, noSubClasses);
	}
