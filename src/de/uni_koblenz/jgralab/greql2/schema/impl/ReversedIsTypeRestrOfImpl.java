...
public class ReversedIsTypeRestrOfImpl extends ReversedAggregationImpl implements Aggregation, Greql2Aggregation, IsTypeRestrOf {

	ReversedIsTypeRestrOfImpl(EdgeImpl e, Graph g) {
		super(e, g);
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		return ((IsTypeRestrOf)normalEdge).getAttribute(attributeName);
	}

	public void setAttribute(String attributeName, Object data) throws NoSuchFieldException {
		((IsTypeRestrOf)normalEdge).setAttribute(attributeName, data);
	}

	public java.util.List<SourcePosition> getSourcePositions() {
		return ((IsTypeRestrOf)normalEdge).getSourcePositions();
	}

	public void setSourcePositions(java.util.List<SourcePosition> sourcePositions) {
		((IsTypeRestrOf)normalEdge).setSourcePositions(sourcePositions);
	}
	...
	public IsTypeRestrOf getNextIsTypeRestrOfInGraph() {
		return ((IsTypeRestrOf)normalEdge).getNextIsTypeRestrOfInGraph();
	}

	public IsTypeRestrOf getNextIsTypeRestrOfInGraph(boolean noSubClasses) {
		return ((IsTypeRestrOf)normalEdge).getNextIsTypeRestrOfInGraph(noSubClasses);
	}
