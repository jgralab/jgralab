...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsRecordElementOfImpl;
...
public class IsRecordElementOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsRecordElementOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsRecordElementOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsRecordElementOf"));
		reversedEdge = new ReversedIsRecordElementOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsRecordElementOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsRecordElementOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsRecordElementOf getNextIsRecordElementOfInGraph() {
		return (IsRecordElementOf)getNextEdgeOfClassInGraph(IsRecordElementOf.class);
	}

	public IsRecordElementOf getNextIsRecordElementOfInGraph(boolean noSubClasses) {
		return (IsRecordElementOf)getNextEdgeOfClassInGraph(IsRecordElementOf.class, noSubClasses);
	}
