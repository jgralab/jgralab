...
public class SetConstructionImpl extends VertexImpl implements Expression, Greql2Vertex, SetConstruction, ValueConstruction, Vertex {

	public SetConstructionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("SetConstruction"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return SetConstruction.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("SetConstruction doesn't contain an attribute " + attributeName);
	}
	...
	public SetConstruction getNextSetConstruction() {
		return (SetConstruction)getNextVertexOfClass(SetConstruction.class);
	}

	public SetConstruction getNextSetConstruction(boolean noSubClasses) {
		return (SetConstruction)getNextVertexOfClass(SetConstruction.class, noSubClasses);
	}
