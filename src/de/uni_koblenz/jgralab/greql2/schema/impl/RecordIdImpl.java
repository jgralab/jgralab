...
public class RecordIdImpl extends VertexImpl implements Expression, Greql2Vertex, Identifier, RecordId, Vertex {

	protected String name;

	public RecordIdImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("RecordId"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("RecordId doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validFromEdges.add(IsRecordIdOfImpl.class);
	...
	public RecordId getNextRecordId() {
		return (RecordId)getNextVertexOfClass(RecordId.class);
	}

	public RecordId getNextRecordId(boolean noSubClasses) {
		return (RecordId)getNextVertexOfClass(RecordId.class, noSubClasses);
	}
