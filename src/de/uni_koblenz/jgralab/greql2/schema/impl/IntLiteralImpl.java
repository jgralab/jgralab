...
public class IntLiteralImpl extends VertexImpl implements Expression, Greql2Vertex, IntLiteral, Literal, Vertex {

	protected int intValue;

	public IntLiteralImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("IntLiteral"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("intValue")) return intValue;
		throw new NoSuchFieldException("IntLiteral doesn't contain an attribute " + attributeName);
	}

	@SuppressWarnings("unchecked")
	public void setAttribute(String attributeName, Object data) throws NoSuchFieldException {
		if (attributeName.equals("intValue")) {
			setIntValue((Integer) data);
			return;
		}
		throw new NoSuchFieldException("IntLiteral doesn't contain an attribute " + attributeName);
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		intValue = io.matchInteger();
		setIntValue(intValue);
	}

	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		io.space();
		io.writeInteger(intValue);
	}
	...
	
	{
		...
		validFromEdges.add(IsExponentOfImpl.class);
	...
	public IntLiteral getNextIntLiteral() {
		return (IntLiteral)getNextVertexOfClass(IntLiteral.class);
	}

	public IntLiteral getNextIntLiteral(boolean noSubClasses) {
		return (IntLiteral)getNextVertexOfClass(IntLiteral.class, noSubClasses);
	}

	public Literal getNextLiteral() {
		return (Literal)getNextVertexOfClass(Literal.class);
	}

	public Literal getNextLiteral(boolean noSubClasses) {
		return (Literal)getNextVertexOfClass(Literal.class, noSubClasses);
	}
