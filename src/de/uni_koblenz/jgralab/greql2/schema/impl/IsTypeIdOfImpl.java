...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsTypeIdOfImpl;
...
public class IsTypeIdOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsTypeIdOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsTypeIdOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsTypeIdOf"));
		reversedEdge = new ReversedIsTypeIdOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsTypeIdOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsTypeIdOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsTypeIdOf getNextIsTypeIdOfInGraph() {
		return (IsTypeIdOf)getNextEdgeOfClassInGraph(IsTypeIdOf.class);
	}

	public IsTypeIdOf getNextIsTypeIdOfInGraph(boolean noSubClasses) {
		return (IsTypeIdOf)getNextEdgeOfClassInGraph(IsTypeIdOf.class, noSubClasses);
	}
