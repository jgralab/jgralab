...
public class TypeIdImpl extends VertexImpl implements Expression, Greql2Vertex, Identifier, Symbol, TypeId, Vertex {
	...
	public TypeIdImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("TypeId"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("excluded")) return excluded;
		if (attributeName.equals("name")) return name;
		if (attributeName.equals("type")) return type;
		throw new NoSuchFieldException("TypeId doesn't contain an attribute " + attributeName);
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		excluded = io.matchBoolean();
		setExcluded(excluded);
		name = io.matchUtfString();
		setName(name);
		type = io.matchBoolean();
		setType(type);
	}

	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		io.space();
		io.writeBoolean(excluded);
		io.writeUtfString(name);
		io.writeBoolean(type);
	}
	...
	
	{
		...
		validFromEdges.add(IsTypeRestrOfImpl.class);
		...
		validFromEdges.add(IsSymbolOfImpl.class);
	...
	public Identifier getNextIdentifier() {
		return (Identifier)getNextVertexOfClass(Identifier.class);
	}

	public Identifier getNextIdentifier(boolean noSubClasses) {
		return (Identifier)getNextVertexOfClass(Identifier.class, noSubClasses);
	}

	public Symbol getNextSymbol() {
		return (Symbol)getNextVertexOfClass(Symbol.class);
	}

	public Symbol getNextSymbol(boolean noSubClasses) {
		return (Symbol)getNextVertexOfClass(Symbol.class, noSubClasses);
	}

	public TypeId getNextTypeId() {
		return (TypeId)getNextVertexOfClass(TypeId.class);
	}

	public TypeId getNextTypeId(boolean noSubClasses) {
		return (TypeId)getNextVertexOfClass(TypeId.class, noSubClasses);
	}
