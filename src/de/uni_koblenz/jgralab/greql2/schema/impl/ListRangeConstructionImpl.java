...
public class ListRangeConstructionImpl extends VertexImpl implements Expression, Greql2Vertex, ListConstruction, ListRangeConstruction, ValueConstruction, Vertex {

	public ListRangeConstructionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("ListRangeConstruction"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("ListRangeConstruction doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsLastValueOfImpl.class);

		validToEdges.add(IsFirstValueOfImpl.class);
	...
	public ListConstruction getNextListConstruction() {
		return (ListConstruction)getNextVertexOfClass(ListConstruction.class);
	}

	public ListConstruction getNextListConstruction(boolean noSubClasses) {
		return (ListConstruction)getNextVertexOfClass(ListConstruction.class, noSubClasses);
	}

	public ListRangeConstruction getNextListRangeConstruction() {
		return (ListRangeConstruction)getNextVertexOfClass(ListRangeConstruction.class);
	}

	public ListRangeConstruction getNextListRangeConstruction(boolean noSubClasses) {
		return (ListRangeConstruction)getNextVertexOfClass(ListRangeConstruction.class, noSubClasses);
	}
