...
public class NullLiteralImpl extends VertexImpl implements Expression, Greql2Vertex, Literal, NullLiteral, Vertex {

	public NullLiteralImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("NullLiteral"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("NullLiteral doesn't contain an attribute " + attributeName);
	}
	...
	public NullLiteral getNextNullLiteral() {
		return (NullLiteral)getNextVertexOfClass(NullLiteral.class);
	}

	public NullLiteral getNextNullLiteral(boolean noSubClasses) {
		return (NullLiteral)getNextVertexOfClass(NullLiteral.class, noSubClasses);
	}
