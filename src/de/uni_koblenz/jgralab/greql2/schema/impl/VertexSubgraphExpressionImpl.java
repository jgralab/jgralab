...
public class VertexSubgraphExpressionImpl extends VertexImpl implements Expression, Greql2Vertex, SubgraphExpression, Vertex, VertexSubgraphExpression {

	public VertexSubgraphExpressionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("VertexSubgraphExpression"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return VertexSubgraphExpression.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("VertexSubgraphExpression doesn't contain an attribute " + attributeName);
	}
	...
	public SubgraphExpression getNextSubgraphExpression() {
		return (SubgraphExpression)getNextVertexOfClass(SubgraphExpression.class);
	}

	public VertexSubgraphExpression getNextVertexSubgraphExpression() {
		return (VertexSubgraphExpression)getNextVertexOfClass(VertexSubgraphExpression.class);
	}

	public VertexSubgraphExpression getNextVertexSubgraphExpression(boolean noSubClasses) {
		return (VertexSubgraphExpression)getNextVertexOfClass(VertexSubgraphExpression.class, noSubClasses);
	}
