...
public class TupleConstructionImpl extends VertexImpl implements Expression, Greql2Vertex, TupleConstruction, ValueConstruction, Vertex {

	public TupleConstructionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("TupleConstruction"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return TupleConstruction.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("TupleConstruction doesn't contain an attribute " + attributeName);
	}
	...
	public TupleConstruction getNextTupleConstruction() {
		return (TupleConstruction)getNextVertexOfClass(TupleConstruction.class);
	}

	public TupleConstruction getNextTupleConstruction(boolean noSubClasses) {
		return (TupleConstruction)getNextVertexOfClass(TupleConstruction.class, noSubClasses);
	}
