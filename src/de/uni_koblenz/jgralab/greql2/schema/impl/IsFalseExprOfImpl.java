...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsFalseExprOfImpl;
...
public class IsFalseExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsFalseExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsFalseExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsFalseExprOf"));
		reversedEdge = new ReversedIsFalseExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsFalseExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsFalseExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsFalseExprOf getNextIsFalseExprOfInGraph() {
		return (IsFalseExprOf)getNextEdgeOfClassInGraph(IsFalseExprOf.class);
	}

	public IsFalseExprOf getNextIsFalseExprOfInGraph(boolean noSubClasses) {
		return (IsFalseExprOf)getNextEdgeOfClassInGraph(IsFalseExprOf.class, noSubClasses);
	}
