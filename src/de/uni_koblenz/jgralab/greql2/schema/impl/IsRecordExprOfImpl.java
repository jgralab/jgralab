...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsRecordExprOfImpl;
...
public class IsRecordExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsRecordExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsRecordExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsRecordExprOf"));
		reversedEdge = new ReversedIsRecordExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsRecordExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsRecordExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsRecordExprOf getNextIsRecordExprOfInGraph() {
		return (IsRecordExprOf)getNextEdgeOfClassInGraph(IsRecordExprOf.class);
	}

	public IsRecordExprOf getNextIsRecordExprOfInGraph(boolean noSubClasses) {
		return (IsRecordExprOf)getNextEdgeOfClassInGraph(IsRecordExprOf.class, noSubClasses);
	}
