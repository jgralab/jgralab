...
public class PathExistenceImpl extends VertexImpl implements Expression, Greql2Vertex, PathExistence, PathExpression, Vertex {

	public PathExistenceImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("PathExistence"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return PathExistence.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("PathExistence doesn't contain an attribute " + attributeName);
	}
	...
	public PathExistence getNextPathExistence() {
		return (PathExistence)getNextVertexOfClass(PathExistence.class);
	}

	public PathExistence getNextPathExistence(boolean noSubClasses) {
		return (PathExistence)getNextVertexOfClass(PathExistence.class, noSubClasses);
	}
