...
public class AttributeIdImpl extends VertexImpl implements AttributeId, Expression, Greql2Vertex, Identifier, Vertex {

	protected String name;

	public AttributeIdImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("AttributeId"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("AttributeId doesn't contain an attribute " + attributeName);
	}
	...
	public AttributeId getNextAttributeId() {
		return (AttributeId)getNextVertexOfClass(AttributeId.class);
	}

	public AttributeId getNextAttributeId(boolean noSubClasses) {
		return (AttributeId)getNextVertexOfClass(AttributeId.class, noSubClasses);
	}
