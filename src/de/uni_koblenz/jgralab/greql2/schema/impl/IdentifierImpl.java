...
public class IdentifierImpl extends VertexImpl implements Expression, Greql2Vertex, Identifier, Vertex {

	protected String name;

	public IdentifierImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("Identifier"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("Identifier doesn't contain an attribute " + attributeName);
	}
