...
public class NonterminalImpl extends VertexImpl implements Expression, Greql2Vertex, Identifier, Nonterminal, Symbol, Vertex {

	protected String name;

	public NonterminalImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("Nonterminal"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("Nonterminal doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validFromEdges.add(IsLeftSideOfImpl.class);
	...
	public Nonterminal getNextNonterminal() {
		return (Nonterminal)getNextVertexOfClass(Nonterminal.class);
	}

	public Nonterminal getNextNonterminal(boolean noSubClasses) {
		return (Nonterminal)getNextVertexOfClass(Nonterminal.class, noSubClasses);
	}
