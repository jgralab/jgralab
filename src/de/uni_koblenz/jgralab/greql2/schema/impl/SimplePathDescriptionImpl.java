...
public class SimplePathDescriptionImpl extends VertexImpl implements Expression, Greql2Vertex, PathDescription, PrimaryPathDescription, SimplePathDescription, Vertex {

	public SimplePathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("SimplePathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return SimplePathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("SimplePathDescription doesn't contain an attribute " + attributeName);
	}
	...
	public SimplePathDescription getNextSimplePathDescription() {
		return (SimplePathDescription)getNextVertexOfClass(SimplePathDescription.class);
	}

	public SimplePathDescription getNextSimplePathDescription(boolean noSubClasses) {
		return (SimplePathDescription)getNextVertexOfClass(SimplePathDescription.class, noSubClasses);
	}
