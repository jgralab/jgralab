...
public class LiteralImpl extends VertexImpl implements Expression, Greql2Vertex, Literal, Vertex {

	public LiteralImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("Literal"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("Literal doesn't contain an attribute " + attributeName);
	}
