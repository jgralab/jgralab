...
public class EdgeSubgraphExpressionImpl extends VertexImpl implements EdgeSubgraphExpression, Expression, Greql2Vertex, SubgraphExpression, Vertex {

	public EdgeSubgraphExpressionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("EdgeSubgraphExpression"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return EdgeSubgraphExpression.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("EdgeSubgraphExpression doesn't contain an attribute " + attributeName);
	}
	...
	public EdgeSubgraphExpression getNextEdgeSubgraphExpression() {
		return (EdgeSubgraphExpression)getNextVertexOfClass(EdgeSubgraphExpression.class);
	}

	public EdgeSubgraphExpression getNextEdgeSubgraphExpression(boolean noSubClasses) {
		return (EdgeSubgraphExpression)getNextVertexOfClass(EdgeSubgraphExpression.class, noSubClasses);
	}
