...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsStartExprOfImpl;
...
public class IsStartExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsStartExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsStartExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsStartExprOf"));
		reversedEdge = new ReversedIsStartExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsStartExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsStartExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsStartExprOf getNextIsStartExprOfInGraph() {
		return (IsStartExprOf)getNextEdgeOfClassInGraph(IsStartExprOf.class);
	}

	public IsStartExprOf getNextIsStartExprOfInGraph(boolean noSubClasses) {
		return (IsStartExprOf)getNextEdgeOfClassInGraph(IsStartExprOf.class, noSubClasses);
	}
