...
public class PathSystemConstructionImpl extends VertexImpl implements Expression, Greql2Vertex, PathSystemConstruction, ValueConstruction, Vertex {

	public PathSystemConstructionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("PathSystemConstruction"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return PathSystemConstruction.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("PathSystemConstruction doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsEdgeVertexListOfImpl.class);

		validToEdges.add(IsRootOfImpl.class);

		validToEdges.add(IsPartOfImpl.class);
	...
	public PathSystemConstruction getNextPathSystemConstruction() {
		return (PathSystemConstruction)getNextVertexOfClass(PathSystemConstruction.class);
	}

	public PathSystemConstruction getNextPathSystemConstruction(boolean noSubClasses) {
		return (PathSystemConstruction)getNextVertexOfClass(PathSystemConstruction.class, noSubClasses);
	}

	public ValueConstruction getNextValueConstruction() {
		return (ValueConstruction)getNextVertexOfClass(ValueConstruction.class);
	}
