...
public class EdgePathDescriptionImpl extends VertexImpl implements EdgePathDescription, Expression, Greql2Vertex, PathDescription, PrimaryPathDescription, Vertex {

	public EdgePathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("EdgePathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return EdgePathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("EdgePathDescription doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsEdgeExprOfImpl.class);

		validToEdges.add(IsDirectionOfImpl.class);

		validToEdges.add(IsEdgeRestrOfImpl.class);
	...
	public EdgePathDescription getNextEdgePathDescription() {
		return (EdgePathDescription)getNextVertexOfClass(EdgePathDescription.class);
	}

	public EdgePathDescription getNextEdgePathDescription(boolean noSubClasses) {
		return (EdgePathDescription)getNextVertexOfClass(EdgePathDescription.class, noSubClasses);
	}
	...
	public PrimaryPathDescription getNextPrimaryPathDescription() {
		return (PrimaryPathDescription)getNextVertexOfClass(PrimaryPathDescription.class);
	}
