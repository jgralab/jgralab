...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsExponentiatedPathOfImpl;
...
public class IsExponentiatedPathOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsExponentiatedPathOf, IsPathDescriptionOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsExponentiatedPathOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsExponentiatedPathOf"));
		reversedEdge = new ReversedIsExponentiatedPathOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsExponentiatedPathOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsExponentiatedPathOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsExponentiatedPathOf getNextIsExponentiatedPathOfInGraph() {
		return (IsExponentiatedPathOf)getNextEdgeOfClassInGraph(IsExponentiatedPathOf.class);
	}

	public IsExponentiatedPathOf getNextIsExponentiatedPathOfInGraph(boolean noSubClasses) {
		return (IsExponentiatedPathOf)getNextEdgeOfClassInGraph(IsExponentiatedPathOf.class, noSubClasses);
	}
