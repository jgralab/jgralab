...
public class RealLiteralImpl extends VertexImpl implements Expression, Greql2Vertex, Literal, RealLiteral, Vertex {

	protected double realValue;

	public RealLiteralImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("RealLiteral"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("realValue")) return realValue;
		throw new NoSuchFieldException("RealLiteral doesn't contain an attribute " + attributeName);
	}

	@SuppressWarnings("unchecked")
	public void setAttribute(String attributeName, Object data) throws NoSuchFieldException {
		if (attributeName.equals("realValue")) {
			setRealValue((Double) data);
			return;
		}
		throw new NoSuchFieldException("RealLiteral doesn't contain an attribute " + attributeName);
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		realValue = io.matchDouble();
		setRealValue(realValue);
	}

	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		io.space();
		io.writeDouble(realValue);
	}
	...
	public RealLiteral getNextRealLiteral() {
		return (RealLiteral)getNextVertexOfClass(RealLiteral.class);
	}

	public RealLiteral getNextRealLiteral(boolean noSubClasses) {
		return (RealLiteral)getNextVertexOfClass(RealLiteral.class, noSubClasses);
	}
