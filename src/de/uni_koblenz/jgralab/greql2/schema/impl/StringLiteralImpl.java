...
public class StringLiteralImpl extends VertexImpl implements Expression, Greql2Vertex, Literal, StringLiteral, Vertex {

	protected String stringValue;

	public StringLiteralImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("StringLiteral"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("stringValue")) return stringValue;
		throw new NoSuchFieldException("StringLiteral doesn't contain an attribute " + attributeName);
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		stringValue = io.matchUtfString();
		setStringValue(stringValue);
	}

	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		io.space();
		io.writeUtfString(stringValue);
	}
	...
	public StringLiteral getNextStringLiteral() {
		return (StringLiteral)getNextVertexOfClass(StringLiteral.class);
	}

	public StringLiteral getNextStringLiteral(boolean noSubClasses) {
		return (StringLiteral)getNextVertexOfClass(StringLiteral.class, noSubClasses);
	}
