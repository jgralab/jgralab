...
public class BagConstructionImpl extends VertexImpl implements BagConstruction, Expression, Greql2Vertex, ValueConstruction, Vertex {

	public BagConstructionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("BagConstruction"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return BagConstruction.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("BagConstruction doesn't contain an attribute " + attributeName);
	}
	...
	public BagConstruction getNextBagConstruction() {
		return (BagConstruction)getNextVertexOfClass(BagConstruction.class);
	}

	public BagConstruction getNextBagConstruction(boolean noSubClasses) {
		return (BagConstruction)getNextVertexOfClass(BagConstruction.class, noSubClasses);
	}
