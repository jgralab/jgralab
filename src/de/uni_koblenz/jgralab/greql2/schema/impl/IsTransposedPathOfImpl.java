...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsTransposedPathOfImpl;
...
public class IsTransposedPathOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsPathDescriptionOf, IsTransposedPathOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsTransposedPathOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsTransposedPathOf"));
		reversedEdge = new ReversedIsTransposedPathOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsTransposedPathOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsTransposedPathOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsTransposedPathOf getNextIsTransposedPathOfInGraph() {
		return (IsTransposedPathOf)getNextEdgeOfClassInGraph(IsTransposedPathOf.class);
	}

	public IsTransposedPathOf getNextIsTransposedPathOfInGraph(boolean noSubClasses) {
		return (IsTransposedPathOf)getNextEdgeOfClassInGraph(IsTransposedPathOf.class, noSubClasses);
	}
