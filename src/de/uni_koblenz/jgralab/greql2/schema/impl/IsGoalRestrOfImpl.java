...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsGoalRestrOfImpl;
...
public class IsGoalRestrOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsGoalRestrOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsGoalRestrOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsGoalRestrOf"));
		reversedEdge = new ReversedIsGoalRestrOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsGoalRestrOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsGoalRestrOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsGoalRestrOf getNextIsGoalRestrOfInGraph() {
		return (IsGoalRestrOf)getNextEdgeOfClassInGraph(IsGoalRestrOf.class);
	}

	public IsGoalRestrOf getNextIsGoalRestrOfInGraph(boolean noSubClasses) {
		return (IsGoalRestrOf)getNextEdgeOfClassInGraph(IsGoalRestrOf.class, noSubClasses);
	}
