...
public class BoolLiteralImpl extends VertexImpl implements BoolLiteral, Expression, Greql2Vertex, Literal, Vertex {

	protected boolean boolValue;

	public BoolLiteralImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("BoolLiteral"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("boolValue")) return boolValue;
		throw new NoSuchFieldException("BoolLiteral doesn't contain an attribute " + attributeName);
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		boolValue = io.matchBoolean();
		setBoolValue(boolValue);
	}

	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		io.space();
		io.writeBoolean(boolValue);
	}
	...
	public BoolLiteral getNextBoolLiteral() {
		return (BoolLiteral)getNextVertexOfClass(BoolLiteral.class);
	}

	public BoolLiteral getNextBoolLiteral(boolean noSubClasses) {
		return (BoolLiteral)getNextVertexOfClass(BoolLiteral.class, noSubClasses);
	}
