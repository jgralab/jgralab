...
public class TableComprehensionImpl extends VertexImpl implements Comprehension, ComprehensionWithTableHeader, Expression, Greql2Vertex, TableComprehension, Vertex {

	public TableComprehensionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("TableComprehension"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return TableComprehension.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("TableComprehension doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsCompResultDefOfImpl.class);

		validToEdges.add(IsRowHeaderExprOfImpl.class);

		validToEdges.add(IsTableHeaderOfImpl.class);

		validToEdges.add(IsCompDeclOfImpl.class);

		validToEdges.add(IsColumnHeaderExprOfImpl.class);

	}

	public Comprehension getNextComprehension() {
		return (Comprehension)getNextVertexOfClass(Comprehension.class);
	}

	public ComprehensionWithTableHeader getNextComprehensionWithTableHeader() {
		return (ComprehensionWithTableHeader)getNextVertexOfClass(ComprehensionWithTableHeader.class);
	}
	...
	public TableComprehension getNextTableComprehension() {
		return (TableComprehension)getNextVertexOfClass(TableComprehension.class);
	}

	public TableComprehension getNextTableComprehension(boolean noSubClasses) {
		return (TableComprehension)getNextVertexOfClass(TableComprehension.class, noSubClasses);
	}
