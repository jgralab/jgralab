...
public class ForwardVertexSetImpl extends VertexImpl implements Expression, ForwardVertexSet, Greql2Vertex, PathExpression, Vertex {

	public ForwardVertexSetImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("ForwardVertexSet"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return ForwardVertexSet.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("ForwardVertexSet doesn't contain an attribute " + attributeName);
	}
	...
	public ForwardVertexSet getNextForwardVertexSet() {
		return (ForwardVertexSet)getNextVertexOfClass(ForwardVertexSet.class);
	}

	public ForwardVertexSet getNextForwardVertexSet(boolean noSubClasses) {
		return (ForwardVertexSet)getNextVertexOfClass(ForwardVertexSet.class, noSubClasses);
	}
