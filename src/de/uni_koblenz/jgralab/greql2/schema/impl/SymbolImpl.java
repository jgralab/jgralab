...
public class SymbolImpl extends VertexImpl implements Expression, Greql2Vertex, Identifier, Symbol, Vertex {

	protected String name;

	public SymbolImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("Symbol"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("Symbol doesn't contain an attribute " + attributeName);
	}
