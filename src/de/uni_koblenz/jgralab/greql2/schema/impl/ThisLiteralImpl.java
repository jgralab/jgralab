...
public class ThisLiteralImpl extends VertexImpl implements Expression, Greql2Vertex, Literal, ThisLiteral, Vertex {

	protected String thisValue;

	public ThisLiteralImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("ThisLiteral"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("thisValue")) return thisValue;
		throw new NoSuchFieldException("ThisLiteral doesn't contain an attribute " + attributeName);
	}

	@SuppressWarnings("unchecked")
	public void setAttribute(String attributeName, Object data) throws NoSuchFieldException {
		if (attributeName.equals("thisValue")) {
			setThisValue((String) data);
			return;
		}
		throw new NoSuchFieldException("ThisLiteral doesn't contain an attribute " + attributeName);
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		thisValue = io.matchUtfString();
		setThisValue(thisValue);
	}

	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		io.space();
		io.writeUtfString(thisValue);
	}
	...
	public ThisLiteral getNextThisLiteral() {
		return (ThisLiteral)getNextVertexOfClass(ThisLiteral.class);
	}

	public ThisLiteral getNextThisLiteral(boolean noSubClasses) {
		return (ThisLiteral)getNextVertexOfClass(ThisLiteral.class, noSubClasses);
	}
