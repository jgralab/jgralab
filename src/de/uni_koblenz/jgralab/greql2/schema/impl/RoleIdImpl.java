...
public class RoleIdImpl extends VertexImpl implements Expression, Greql2Vertex, Identifier, RoleId, Vertex {

	protected String name;

	public RoleIdImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("RoleId"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("RoleId doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validFromEdges.add(IsRoleIdOfImpl.class);
	...
	public RoleId getNextRoleId() {
		return (RoleId)getNextVertexOfClass(RoleId.class);
	}

	public RoleId getNextRoleId(boolean noSubClasses) {
		return (RoleId)getNextVertexOfClass(RoleId.class, noSubClasses);
	}
