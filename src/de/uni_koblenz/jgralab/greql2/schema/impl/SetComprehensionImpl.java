...
public class SetComprehensionImpl extends VertexImpl implements Comprehension, Expression, Greql2Vertex, SetComprehension, Vertex {

	public SetComprehensionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("SetComprehension"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return SetComprehension.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("SetComprehension doesn't contain an attribute " + attributeName);
	}
	...
	public SetComprehension getNextSetComprehension() {
		return (SetComprehension)getNextVertexOfClass(SetComprehension.class);
	}

	public SetComprehension getNextSetComprehension(boolean noSubClasses) {
		return (SetComprehension)getNextVertexOfClass(SetComprehension.class, noSubClasses);
	}
