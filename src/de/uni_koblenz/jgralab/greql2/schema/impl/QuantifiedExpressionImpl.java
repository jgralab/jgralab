...
public class QuantifiedExpressionImpl extends VertexImpl implements Expression, Greql2Vertex, QuantifiedExpression, Vertex {

	public QuantifiedExpressionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("QuantifiedExpression"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return QuantifiedExpression.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("QuantifiedExpression doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsBoundExprOfQuantifierImpl.class);

		validToEdges.add(IsQuantifierOfImpl.class);

		validToEdges.add(IsQuantifiedDeclOfImpl.class);
	...
	public QuantifiedExpression getNextQuantifiedExpression() {
		return (QuantifiedExpression)getNextVertexOfClass(QuantifiedExpression.class);
	}

	public QuantifiedExpression getNextQuantifiedExpression(boolean noSubClasses) {
		return (QuantifiedExpression)getNextVertexOfClass(QuantifiedExpression.class, noSubClasses);
	}
