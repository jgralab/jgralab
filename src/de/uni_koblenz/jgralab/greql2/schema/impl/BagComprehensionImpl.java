...
public class BagComprehensionImpl extends VertexImpl implements BagComprehension, Comprehension, ComprehensionWithTableHeader, Expression, Greql2Vertex, Vertex {

	public BagComprehensionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("BagComprehension"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return BagComprehension.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("BagComprehension doesn't contain an attribute " + attributeName);
	}
	...
	public BagComprehension getNextBagComprehension() {
		return (BagComprehension)getNextVertexOfClass(BagComprehension.class);
	}

	public BagComprehension getNextBagComprehension(boolean noSubClasses) {
		return (BagComprehension)getNextVertexOfClass(BagComprehension.class, noSubClasses);
	}
