...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsQueryExprOfImpl;
...
public class IsQueryExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsQueryExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsQueryExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsQueryExprOf"));
		reversedEdge = new ReversedIsQueryExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsQueryExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsQueryExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsQueryExprOf getNextIsQueryExprOfInGraph() {
		return (IsQueryExprOf)getNextEdgeOfClassInGraph(IsQueryExprOf.class);
	}

	public IsQueryExprOf getNextIsQueryExprOfInGraph(boolean noSubClasses) {
		return (IsQueryExprOf)getNextEdgeOfClassInGraph(IsQueryExprOf.class, noSubClasses);
	}
