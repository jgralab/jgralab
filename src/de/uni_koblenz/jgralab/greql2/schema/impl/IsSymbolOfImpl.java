...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsSymbolOfImpl;
...
/**
FromVertexClass: Symbol
FromRoleName : 
ToVertexClass: RightSide
toRoleName : 
 */

public class IsSymbolOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsSymbolOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsSymbolOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsSymbolOf"));
		reversedEdge = new ReversedIsSymbolOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsSymbolOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsSymbolOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsSymbolOf getNextIsSymbolOfInGraph() {
		return (IsSymbolOf)getNextEdgeOfClassInGraph(IsSymbolOf.class);
	}

	public IsSymbolOf getNextIsSymbolOfInGraph(boolean noSubClasses) {
		return (IsSymbolOf)getNextEdgeOfClassInGraph(IsSymbolOf.class, noSubClasses);
	}
