...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsColumnHeaderExprOfImpl;
...
public class IsColumnHeaderExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsColumnHeaderExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsColumnHeaderExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsColumnHeaderExprOf"));
		reversedEdge = new ReversedIsColumnHeaderExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsColumnHeaderExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsColumnHeaderExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsColumnHeaderExprOf getNextIsColumnHeaderExprOfInGraph() {
		return (IsColumnHeaderExprOf)getNextEdgeOfClassInGraph(IsColumnHeaderExprOf.class);
	}

	public IsColumnHeaderExprOf getNextIsColumnHeaderExprOfInGraph(boolean noSubClasses) {
		return (IsColumnHeaderExprOf)getNextEdgeOfClassInGraph(IsColumnHeaderExprOf.class, noSubClasses);
	}
	...
	public IsColumnHeaderExprOf getNextIsColumnHeaderExprOf() {
		return (IsColumnHeaderExprOf)getNextEdgeOfClass(IsColumnHeaderExprOf.class);
	}

	public IsColumnHeaderExprOf getNextIsColumnHeaderExprOf(EdgeDirection orientation) {
		return (IsColumnHeaderExprOf)getNextEdgeOfClass(IsColumnHeaderExprOf.class, orientation);
	}

	public IsColumnHeaderExprOf getNextIsColumnHeaderExprOf(boolean noSubClasses) {
		return (IsColumnHeaderExprOf)getNextEdgeOfClass(IsColumnHeaderExprOf.class, noSubClasses);
	}

	public IsColumnHeaderExprOf getNextIsColumnHeaderExprOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsColumnHeaderExprOf)getNextEdgeOfClass(IsColumnHeaderExprOf.class, orientation, noSubClasses);
	}
