...
public class WhereExpressionImpl extends VertexImpl implements DefinitionExpression, Expression, Greql2Vertex, Vertex, WhereExpression {

	public WhereExpressionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("WhereExpression"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("WhereExpression doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsDefinitionOfImpl.class);

		validToEdges.add(IsBoundExprOfDefinitionImpl.class);

	}

	public DefinitionExpression getNextDefinitionExpression() {
		return (DefinitionExpression)getNextVertexOfClass(DefinitionExpression.class);
	}
	...
	public WhereExpression getNextWhereExpression() {
		return (WhereExpression)getNextVertexOfClass(WhereExpression.class);
	}

	public WhereExpression getNextWhereExpression(boolean noSubClasses) {
		return (WhereExpression)getNextVertexOfClass(WhereExpression.class, noSubClasses);
	}
