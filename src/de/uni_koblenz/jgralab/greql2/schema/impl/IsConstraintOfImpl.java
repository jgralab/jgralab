...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsConstraintOfImpl;
...
public class IsConstraintOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsConstraintOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsConstraintOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsConstraintOf"));
		reversedEdge = new ReversedIsConstraintOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsConstraintOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsConstraintOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsConstraintOf getNextIsConstraintOfInGraph() {
		return (IsConstraintOf)getNextEdgeOfClassInGraph(IsConstraintOf.class);
	}

	public IsConstraintOf getNextIsConstraintOfInGraph(boolean noSubClasses) {
		return (IsConstraintOf)getNextEdgeOfClassInGraph(IsConstraintOf.class, noSubClasses);
	}
	...
	public IsConstraintOf getNextIsConstraintOf() {
		return (IsConstraintOf)getNextEdgeOfClass(IsConstraintOf.class);
	}

	public IsConstraintOf getNextIsConstraintOf(EdgeDirection orientation) {
		return (IsConstraintOf)getNextEdgeOfClass(IsConstraintOf.class, orientation);
	}

	public IsConstraintOf getNextIsConstraintOf(boolean noSubClasses) {
		return (IsConstraintOf)getNextEdgeOfClass(IsConstraintOf.class, noSubClasses);
	}

	public IsConstraintOf getNextIsConstraintOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsConstraintOf)getNextEdgeOfClass(IsConstraintOf.class, orientation, noSubClasses);
	}
