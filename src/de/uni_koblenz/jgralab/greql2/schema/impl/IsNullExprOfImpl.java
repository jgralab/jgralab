...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsNullExprOfImpl;
...
public class IsNullExprOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsNullExprOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsNullExprOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsNullExprOf"));
		reversedEdge = new ReversedIsNullExprOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsNullExprOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsNullExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsNullExprOf getNextIsNullExprOfInGraph() {
		return (IsNullExprOf)getNextEdgeOfClassInGraph(IsNullExprOf.class);
	}

	public IsNullExprOf getNextIsNullExprOfInGraph(boolean noSubClasses) {
		return (IsNullExprOf)getNextEdgeOfClassInGraph(IsNullExprOf.class, noSubClasses);
	}
