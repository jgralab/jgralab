...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsEdgeRestrOfImpl;
...
public class IsEdgeRestrOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsEdgeRestrOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsEdgeRestrOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsEdgeRestrOf"));
		reversedEdge = new ReversedIsEdgeRestrOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsEdgeRestrOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsEdgeRestrOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsEdgeRestrOf getNextIsEdgeRestrOfInGraph() {
		return (IsEdgeRestrOf)getNextEdgeOfClassInGraph(IsEdgeRestrOf.class);
	}

	public IsEdgeRestrOf getNextIsEdgeRestrOfInGraph(boolean noSubClasses) {
		return (IsEdgeRestrOf)getNextEdgeOfClassInGraph(IsEdgeRestrOf.class, noSubClasses);
	}
