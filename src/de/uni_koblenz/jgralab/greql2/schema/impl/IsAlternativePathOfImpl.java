...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsAlternativePathOfImpl;
...
public class IsAlternativePathOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsAlternativePathOf, IsPathDescriptionOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsAlternativePathOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsAlternativePathOf"));
		reversedEdge = new ReversedIsAlternativePathOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsAlternativePathOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsAlternativePathOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsAlternativePathOf getNextIsAlternativePathOfInGraph() {
		return (IsAlternativePathOf)getNextEdgeOfClassInGraph(IsAlternativePathOf.class);
	}

	public IsAlternativePathOf getNextIsAlternativePathOfInGraph(boolean noSubClasses) {
		return (IsAlternativePathOf)getNextEdgeOfClassInGraph(IsAlternativePathOf.class, noSubClasses);
	}
