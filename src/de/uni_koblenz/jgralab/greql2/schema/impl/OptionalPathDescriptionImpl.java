...
public class OptionalPathDescriptionImpl extends VertexImpl implements Expression, Greql2Vertex, OptionalPathDescription, PathDescription, Vertex {

	public OptionalPathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("OptionalPathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return OptionalPathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("OptionalPathDescription doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsOptionalPathOfImpl.class);
	...
	public OptionalPathDescription getNextOptionalPathDescription() {
		return (OptionalPathDescription)getNextVertexOfClass(OptionalPathDescription.class);
	}

	public OptionalPathDescription getNextOptionalPathDescription(boolean noSubClasses) {
		return (OptionalPathDescription)getNextVertexOfClass(OptionalPathDescription.class, noSubClasses);
	}
