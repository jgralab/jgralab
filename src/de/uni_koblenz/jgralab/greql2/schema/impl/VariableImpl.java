...
public class VariableImpl extends VertexImpl implements Expression, Greql2Vertex, Identifier, Variable, Vertex {

	protected String name;

	public VariableImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("Variable"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("Variable doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validFromEdges.add(IsBoundVarOfImpl.class);
		...
		validFromEdges.add(IsDeclaredVarOfImpl.class);
		...
		validFromEdges.add(IsVarOfImpl.class);
	...
	public Variable getNextVariable() {
		return (Variable)getNextVertexOfClass(Variable.class);
	}

	public Variable getNextVariable(boolean noSubClasses) {
		return (Variable)getNextVertexOfClass(Variable.class, noSubClasses);
	}
