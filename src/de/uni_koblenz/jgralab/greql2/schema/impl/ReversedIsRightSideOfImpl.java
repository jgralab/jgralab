...
public class ReversedIsRightSideOfImpl extends ReversedAggregationImpl implements Aggregation, Greql2Aggregation, IsRightSideOf {

	ReversedIsRightSideOfImpl(EdgeImpl e, Graph g) {
		super(e, g);
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		return ((IsRightSideOf)normalEdge).getAttribute(attributeName);
	}

	public void setAttribute(String attributeName, Object data) throws NoSuchFieldException {
		((IsRightSideOf)normalEdge).setAttribute(attributeName, data);
	}

	public java.util.List<SourcePosition> getSourcePositions() {
		return ((IsRightSideOf)normalEdge).getSourcePositions();
	}

	public void setSourcePositions(java.util.List<SourcePosition> sourcePositions) {
		((IsRightSideOf)normalEdge).setSourcePositions(sourcePositions);
	}
	...
	public IsRightSideOf getNextIsRightSideOfInGraph() {
		return ((IsRightSideOf)normalEdge).getNextIsRightSideOfInGraph();
	}

	public IsRightSideOf getNextIsRightSideOfInGraph(boolean noSubClasses) {
		return ((IsRightSideOf)normalEdge).getNextIsRightSideOfInGraph(noSubClasses);
	}
