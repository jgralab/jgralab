...
public class SequentialPathDescriptionImpl extends VertexImpl implements Expression, Greql2Vertex, PathDescription, SequentialPathDescription, Vertex {

	public SequentialPathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("SequentialPathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return SequentialPathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("SequentialPathDescription doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsSequenceElementOfImpl.class);
	...
	public SequentialPathDescription getNextSequentialPathDescription() {
		return (SequentialPathDescription)getNextVertexOfClass(SequentialPathDescription.class);
	}

	public SequentialPathDescription getNextSequentialPathDescription(boolean noSubClasses) {
		return (SequentialPathDescription)getNextVertexOfClass(SequentialPathDescription.class, noSubClasses);
	}
