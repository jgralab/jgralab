...
public class VertexSetExpressionImpl extends VertexImpl implements ElementSetExpression, Expression, Greql2Vertex, Vertex, VertexSetExpression {

	public VertexSetExpressionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("VertexSetExpression"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return VertexSetExpression.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("VertexSetExpression doesn't contain an attribute " + attributeName);
	}
	...
	public ElementSetExpression getNextElementSetExpression() {
		return (ElementSetExpression)getNextVertexOfClass(ElementSetExpression.class);
	}
	...
	public VertexSetExpression getNextVertexSetExpression() {
		return (VertexSetExpression)getNextVertexOfClass(VertexSetExpression.class);
	}

	public VertexSetExpression getNextVertexSetExpression(boolean noSubClasses) {
		return (VertexSetExpression)getNextVertexOfClass(VertexSetExpression.class, noSubClasses);
	}
