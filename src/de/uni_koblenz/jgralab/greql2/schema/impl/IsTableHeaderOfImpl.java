...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsTableHeaderOfImpl;
...
public class IsTableHeaderOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsTableHeaderOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsTableHeaderOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsTableHeaderOf"));
		reversedEdge = new ReversedIsTableHeaderOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsTableHeaderOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsTableHeaderOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsTableHeaderOf getNextIsTableHeaderOfInGraph() {
		return (IsTableHeaderOf)getNextEdgeOfClassInGraph(IsTableHeaderOf.class);
	}

	public IsTableHeaderOf getNextIsTableHeaderOfInGraph(boolean noSubClasses) {
		return (IsTableHeaderOf)getNextEdgeOfClassInGraph(IsTableHeaderOf.class, noSubClasses);
	}
