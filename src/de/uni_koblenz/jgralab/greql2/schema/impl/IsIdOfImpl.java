...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsIdOfImpl;
...
public class IsIdOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsIdOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsIdOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsIdOf"));
		reversedEdge = new ReversedIsIdOfImpl(this, g);
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsIdOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsIdOf getNextIsIdOfInGraph() {
		return (IsIdOf)getNextEdgeOfClassInGraph(IsIdOf.class);
	}

	public IsIdOf getNextIsIdOfInGraph(boolean noSubClasses) {
		return (IsIdOf)getNextEdgeOfClassInGraph(IsIdOf.class, noSubClasses);
	}
	...
	public IsIdOf getNextIsIdOf() {
		return (IsIdOf)getNextEdgeOfClass(IsIdOf.class);
	}

	public IsIdOf getNextIsIdOf(EdgeDirection orientation) {
		return (IsIdOf)getNextEdgeOfClass(IsIdOf.class, orientation);
	}

	public IsIdOf getNextIsIdOf(boolean noSubClasses) {
		return (IsIdOf)getNextEdgeOfClass(IsIdOf.class, noSubClasses);
	}

	public IsIdOf getNextIsIdOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsIdOf)getNextEdgeOfClass(IsIdOf.class, orientation, noSubClasses);
	}
