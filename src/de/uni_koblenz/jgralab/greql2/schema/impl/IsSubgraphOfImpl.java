...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsSubgraphOfImpl;
...
public class IsSubgraphOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsSubgraphOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsSubgraphOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsSubgraphOf"));
		reversedEdge = new ReversedIsSubgraphOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsSubgraphOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsSubgraphOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsSubgraphOf getNextIsSubgraphOfInGraph() {
		return (IsSubgraphOf)getNextEdgeOfClassInGraph(IsSubgraphOf.class);
	}

	public IsSubgraphOf getNextIsSubgraphOfInGraph(boolean noSubClasses) {
		return (IsSubgraphOf)getNextEdgeOfClassInGraph(IsSubgraphOf.class, noSubClasses);
	}
	...
	public IsSubgraphOf getNextIsSubgraphOf() {
		return (IsSubgraphOf)getNextEdgeOfClass(IsSubgraphOf.class);
	}

	public IsSubgraphOf getNextIsSubgraphOf(EdgeDirection orientation) {
		return (IsSubgraphOf)getNextEdgeOfClass(IsSubgraphOf.class, orientation);
	}

	public IsSubgraphOf getNextIsSubgraphOf(boolean noSubClasses) {
		return (IsSubgraphOf)getNextEdgeOfClass(IsSubgraphOf.class, noSubClasses);
	}

	public IsSubgraphOf getNextIsSubgraphOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsSubgraphOf)getNextEdgeOfClass(IsSubgraphOf.class, orientation, noSubClasses);
	}
