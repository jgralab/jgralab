...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsFirstValueOfImpl;
...
public class IsFirstValueOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsFirstValueOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsFirstValueOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsFirstValueOf"));
		reversedEdge = new ReversedIsFirstValueOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsFirstValueOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsFirstValueOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsFirstValueOf getNextIsFirstValueOfInGraph() {
		return (IsFirstValueOf)getNextEdgeOfClassInGraph(IsFirstValueOf.class);
	}

	public IsFirstValueOf getNextIsFirstValueOfInGraph(boolean noSubClasses) {
		return (IsFirstValueOf)getNextEdgeOfClassInGraph(IsFirstValueOf.class, noSubClasses);
	}
