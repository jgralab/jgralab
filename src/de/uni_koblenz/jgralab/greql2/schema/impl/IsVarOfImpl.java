...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsVarOfImpl;
...
public class IsVarOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsVarOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsVarOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsVarOf"));
		reversedEdge = new ReversedIsVarOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsVarOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsVarOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsVarOf getNextIsVarOfInGraph() {
		return (IsVarOf)getNextEdgeOfClassInGraph(IsVarOf.class);
	}

	public IsVarOf getNextIsVarOfInGraph(boolean noSubClasses) {
		return (IsVarOf)getNextEdgeOfClassInGraph(IsVarOf.class, noSubClasses);
	}
