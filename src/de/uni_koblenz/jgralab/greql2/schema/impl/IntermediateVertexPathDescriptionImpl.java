...
public class IntermediateVertexPathDescriptionImpl extends VertexImpl implements Expression, Greql2Vertex, IntermediateVertexPathDescription, PathDescription, Vertex {

	public IntermediateVertexPathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("IntermediateVertexPathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IntermediateVertexPathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("IntermediateVertexPathDescription doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsIntermediateVertexOfImpl.class);

		validToEdges.add(IsSubPathOfImpl.class);
	...
	public IntermediateVertexPathDescription getNextIntermediateVertexPathDescription() {
		return (IntermediateVertexPathDescription)getNextVertexOfClass(IntermediateVertexPathDescription.class);
	}

	public IntermediateVertexPathDescription getNextIntermediateVertexPathDescription(boolean noSubClasses) {
		return (IntermediateVertexPathDescription)getNextVertexOfClass(IntermediateVertexPathDescription.class, noSubClasses);
	}
