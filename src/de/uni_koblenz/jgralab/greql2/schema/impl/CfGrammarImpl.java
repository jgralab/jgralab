...
public class CfGrammarImpl extends VertexImpl implements CfGrammar, Expression, Greql2Vertex, Vertex {

	public CfGrammarImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("CfGrammar"));
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("CfGrammar doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsProductionOfImpl.class);

	}

	public CfGrammar getNextCfGrammar() {
		return (CfGrammar)getNextVertexOfClass(CfGrammar.class);
	}

	public CfGrammar getNextCfGrammar(boolean noSubClasses) {
		return (CfGrammar)getNextVertexOfClass(CfGrammar.class, noSubClasses);
	}
