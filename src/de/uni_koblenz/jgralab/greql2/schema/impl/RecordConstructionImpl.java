...
public class RecordConstructionImpl extends VertexImpl implements Expression, Greql2Vertex, RecordConstruction, ValueConstruction, Vertex {

	public RecordConstructionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("RecordConstruction"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return RecordConstruction.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("RecordConstruction doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsRecordElementOfImpl.class);
	...
	public RecordConstruction getNextRecordConstruction() {
		return (RecordConstruction)getNextVertexOfClass(RecordConstruction.class);
	}

	public RecordConstruction getNextRecordConstruction(boolean noSubClasses) {
		return (RecordConstruction)getNextVertexOfClass(RecordConstruction.class, noSubClasses);
	}
