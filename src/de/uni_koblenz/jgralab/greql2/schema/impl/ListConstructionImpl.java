...
public class ListConstructionImpl extends VertexImpl implements Expression, Greql2Vertex, ListConstruction, ValueConstruction, Vertex {

	public ListConstructionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("ListConstruction"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return ListConstruction.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("ListConstruction doesn't contain an attribute " + attributeName);
	}
