...
public class ExponentiatedPathDescriptionImpl extends VertexImpl implements ExponentiatedPathDescription, Expression, Greql2Vertex, PathDescription, Vertex {

	public ExponentiatedPathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("ExponentiatedPathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return ExponentiatedPathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("ExponentiatedPathDescription doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validFromEdges.add(IsAlternativePathOfImpl.class);

		validFromEdges.add(IsTransposedPathOfImpl.class);

		validFromEdges.add(IsSubPathOfImpl.class);

		validFromEdges.add(IsStartExprOfImpl.class);

		validFromEdges.add(IsQueryExprOfImpl.class);

		validFromEdges.add(IsOptionalPathOfImpl.class);
		...
		validFromEdges.add(IsSequenceElementOfImpl.class);
		...
		validFromEdges.add(IsExponentiatedPathOfImpl.class);

		validFromEdges.add(IsIteratedPathOfImpl.class);
	...
	
	{
		...
		validToEdges.add(IsGoalRestrOfImpl.class);

		validToEdges.add(IsExponentOfImpl.class);

		validToEdges.add(IsExponentiatedPathOfImpl.class);

		validToEdges.add(IsStartRestrOfImpl.class);

	}

	public ExponentiatedPathDescription getNextExponentiatedPathDescription() {
		return (ExponentiatedPathDescription)getNextVertexOfClass(ExponentiatedPathDescription.class);
	}

	public ExponentiatedPathDescription getNextExponentiatedPathDescription(boolean noSubClasses) {
		return (ExponentiatedPathDescription)getNextVertexOfClass(ExponentiatedPathDescription.class, noSubClasses);
	}
	...
	public PathDescription getNextPathDescription() {
		return (PathDescription)getNextVertexOfClass(PathDescription.class);
	}
	...
	public IsAlternativePathOf getFirstIsAlternativePathOf() {
		return (IsAlternativePathOf)getFirstEdgeOfClass(IsAlternativePathOf.class);
	}

	public IsAlternativePathOf getFirstIsAlternativePathOf(EdgeDirection orientation) {
		return (IsAlternativePathOf)getFirstEdgeOfClass(IsAlternativePathOf.class, orientation);
	}

	public IsAlternativePathOf getFirstIsAlternativePathOf(boolean noSubClasses) {
		return (IsAlternativePathOf)getFirstEdgeOfClass(IsAlternativePathOf.class, noSubClasses);
	}

	public IsAlternativePathOf getFirstIsAlternativePathOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsAlternativePathOf)getFirstEdgeOfClass(IsAlternativePathOf.class, orientation, noSubClasses);
	}

	public IsTransposedPathOf getFirstIsTransposedPathOf() {
		return (IsTransposedPathOf)getFirstEdgeOfClass(IsTransposedPathOf.class);
	}

	public IsTransposedPathOf getFirstIsTransposedPathOf(EdgeDirection orientation) {
		return (IsTransposedPathOf)getFirstEdgeOfClass(IsTransposedPathOf.class, orientation);
	}

	public IsTransposedPathOf getFirstIsTransposedPathOf(boolean noSubClasses) {
		return (IsTransposedPathOf)getFirstEdgeOfClass(IsTransposedPathOf.class, noSubClasses);
	}

	public IsTransposedPathOf getFirstIsTransposedPathOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsTransposedPathOf)getFirstEdgeOfClass(IsTransposedPathOf.class, orientation, noSubClasses);
	}

	public IsSubPathOf getFirstIsSubPathOf() {
		return (IsSubPathOf)getFirstEdgeOfClass(IsSubPathOf.class);
	}

	public IsSubPathOf getFirstIsSubPathOf(EdgeDirection orientation) {
		return (IsSubPathOf)getFirstEdgeOfClass(IsSubPathOf.class, orientation);
	}

	public IsSubPathOf getFirstIsSubPathOf(boolean noSubClasses) {
		return (IsSubPathOf)getFirstEdgeOfClass(IsSubPathOf.class, noSubClasses);
	}

	public IsSubPathOf getFirstIsSubPathOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsSubPathOf)getFirstEdgeOfClass(IsSubPathOf.class, orientation, noSubClasses);
	}
	...
	public IsOptionalPathOf getFirstIsOptionalPathOf() {
		return (IsOptionalPathOf)getFirstEdgeOfClass(IsOptionalPathOf.class);
	}

	public IsOptionalPathOf getFirstIsOptionalPathOf(EdgeDirection orientation) {
		return (IsOptionalPathOf)getFirstEdgeOfClass(IsOptionalPathOf.class, orientation);
	}

	public IsOptionalPathOf getFirstIsOptionalPathOf(boolean noSubClasses) {
		return (IsOptionalPathOf)getFirstEdgeOfClass(IsOptionalPathOf.class, noSubClasses);
	}

	public IsOptionalPathOf getFirstIsOptionalPathOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsOptionalPathOf)getFirstEdgeOfClass(IsOptionalPathOf.class, orientation, noSubClasses);
	}
	...
	public IsExponentOf getFirstIsExponentOf() {
		return (IsExponentOf)getFirstEdgeOfClass(IsExponentOf.class);
	}

	public IsExponentOf getFirstIsExponentOf(EdgeDirection orientation) {
		return (IsExponentOf)getFirstEdgeOfClass(IsExponentOf.class, orientation);
	}

	public IsExponentOf getFirstIsExponentOf(boolean noSubClasses) {
		return (IsExponentOf)getFirstEdgeOfClass(IsExponentOf.class, noSubClasses);
	}

	public IsExponentOf getFirstIsExponentOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsExponentOf)getFirstEdgeOfClass(IsExponentOf.class, orientation, noSubClasses);
	}

	public IsSequenceElementOf getFirstIsSequenceElementOf() {
		return (IsSequenceElementOf)getFirstEdgeOfClass(IsSequenceElementOf.class);
	}

	public IsSequenceElementOf getFirstIsSequenceElementOf(EdgeDirection orientation) {
		return (IsSequenceElementOf)getFirstEdgeOfClass(IsSequenceElementOf.class, orientation);
	}

	public IsSequenceElementOf getFirstIsSequenceElementOf(boolean noSubClasses) {
		return (IsSequenceElementOf)getFirstEdgeOfClass(IsSequenceElementOf.class, noSubClasses);
	}

	public IsSequenceElementOf getFirstIsSequenceElementOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsSequenceElementOf)getFirstEdgeOfClass(IsSequenceElementOf.class, orientation, noSubClasses);
	}
	...
	public IsPathDescriptionOf getFirstIsPathDescriptionOf() {
		return (IsPathDescriptionOf)getFirstEdgeOfClass(IsPathDescriptionOf.class);
	}

	public IsPathDescriptionOf getFirstIsPathDescriptionOf(EdgeDirection orientation) {
		return (IsPathDescriptionOf)getFirstEdgeOfClass(IsPathDescriptionOf.class, orientation);
	}
	...
	public IsExponentiatedPathOf getFirstIsExponentiatedPathOf() {
		return (IsExponentiatedPathOf)getFirstEdgeOfClass(IsExponentiatedPathOf.class);
	}

	public IsExponentiatedPathOf getFirstIsExponentiatedPathOf(EdgeDirection orientation) {
		return (IsExponentiatedPathOf)getFirstEdgeOfClass(IsExponentiatedPathOf.class, orientation);
	}

	public IsExponentiatedPathOf getFirstIsExponentiatedPathOf(boolean noSubClasses) {
		return (IsExponentiatedPathOf)getFirstEdgeOfClass(IsExponentiatedPathOf.class, noSubClasses);
	}

	public IsExponentiatedPathOf getFirstIsExponentiatedPathOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsExponentiatedPathOf)getFirstEdgeOfClass(IsExponentiatedPathOf.class, orientation, noSubClasses);
	}
	...
	public IsIteratedPathOf getFirstIsIteratedPathOf() {
		return (IsIteratedPathOf)getFirstEdgeOfClass(IsIteratedPathOf.class);
	}

	public IsIteratedPathOf getFirstIsIteratedPathOf(EdgeDirection orientation) {
		return (IsIteratedPathOf)getFirstEdgeOfClass(IsIteratedPathOf.class, orientation);
	}

	public IsIteratedPathOf getFirstIsIteratedPathOf(boolean noSubClasses) {
		return (IsIteratedPathOf)getFirstEdgeOfClass(IsIteratedPathOf.class, noSubClasses);
	}

	public IsIteratedPathOf getFirstIsIteratedPathOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsIteratedPathOf)getFirstEdgeOfClass(IsIteratedPathOf.class, orientation, noSubClasses);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsAlternativePathOf, ? extends Vertex>> getIsAlternativePathOfIncidences() {
		return new IncidenceIterable<IsAlternativePathOf, Vertex>(this, IsAlternativePathOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsAlternativePathOf, ? extends Vertex>> getIsAlternativePathOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsAlternativePathOf, Vertex>(this, IsAlternativePathOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsAlternativePathOf, ? extends Vertex>> getIsAlternativePathOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsAlternativePathOf, Vertex>(this, IsAlternativePathOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsAlternativePathOf, ? extends Vertex>> getIsAlternativePathOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsAlternativePathOf, Vertex>(this, IsAlternativePathOf.class, direction);
	}

	public Iterable<EdgeVertexPair<? extends IsTransposedPathOf, ? extends Vertex>> getIsTransposedPathOfIncidences() {
		return new IncidenceIterable<IsTransposedPathOf, Vertex>(this, IsTransposedPathOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsTransposedPathOf, ? extends Vertex>> getIsTransposedPathOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsTransposedPathOf, Vertex>(this, IsTransposedPathOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsTransposedPathOf, ? extends Vertex>> getIsTransposedPathOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsTransposedPathOf, Vertex>(this, IsTransposedPathOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsTransposedPathOf, ? extends Vertex>> getIsTransposedPathOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsTransposedPathOf, Vertex>(this, IsTransposedPathOf.class, direction);
	}

	public Iterable<EdgeVertexPair<? extends IsSubPathOf, ? extends Vertex>> getIsSubPathOfIncidences() {
		return new IncidenceIterable<IsSubPathOf, Vertex>(this, IsSubPathOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsSubPathOf, ? extends Vertex>> getIsSubPathOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsSubPathOf, Vertex>(this, IsSubPathOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsSubPathOf, ? extends Vertex>> getIsSubPathOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsSubPathOf, Vertex>(this, IsSubPathOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsSubPathOf, ? extends Vertex>> getIsSubPathOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsSubPathOf, Vertex>(this, IsSubPathOf.class, direction);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsOptionalPathOf, ? extends Vertex>> getIsOptionalPathOfIncidences() {
		return new IncidenceIterable<IsOptionalPathOf, Vertex>(this, IsOptionalPathOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsOptionalPathOf, ? extends Vertex>> getIsOptionalPathOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsOptionalPathOf, Vertex>(this, IsOptionalPathOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsOptionalPathOf, ? extends Vertex>> getIsOptionalPathOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsOptionalPathOf, Vertex>(this, IsOptionalPathOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsOptionalPathOf, ? extends Vertex>> getIsOptionalPathOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsOptionalPathOf, Vertex>(this, IsOptionalPathOf.class, direction);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsExponentOf, ? extends Vertex>> getIsExponentOfIncidences() {
		return new IncidenceIterable<IsExponentOf, Vertex>(this, IsExponentOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsExponentOf, ? extends Vertex>> getIsExponentOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsExponentOf, Vertex>(this, IsExponentOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsExponentOf, ? extends Vertex>> getIsExponentOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsExponentOf, Vertex>(this, IsExponentOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsExponentOf, ? extends Vertex>> getIsExponentOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsExponentOf, Vertex>(this, IsExponentOf.class, direction);
	}

	public Iterable<EdgeVertexPair<? extends IsSequenceElementOf, ? extends Vertex>> getIsSequenceElementOfIncidences() {
		return new IncidenceIterable<IsSequenceElementOf, Vertex>(this, IsSequenceElementOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsSequenceElementOf, ? extends Vertex>> getIsSequenceElementOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsSequenceElementOf, Vertex>(this, IsSequenceElementOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsSequenceElementOf, ? extends Vertex>> getIsSequenceElementOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsSequenceElementOf, Vertex>(this, IsSequenceElementOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsSequenceElementOf, ? extends Vertex>> getIsSequenceElementOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsSequenceElementOf, Vertex>(this, IsSequenceElementOf.class, direction);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsPathDescriptionOf, ? extends Vertex>> getIsPathDescriptionOfIncidences() {
		return new IncidenceIterable<IsPathDescriptionOf, Vertex>(this, IsPathDescriptionOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsPathDescriptionOf, ? extends Vertex>> getIsPathDescriptionOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsPathDescriptionOf, Vertex>(this, IsPathDescriptionOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsPathDescriptionOf, ? extends Vertex>> getIsPathDescriptionOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsPathDescriptionOf, Vertex>(this, IsPathDescriptionOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsPathDescriptionOf, ? extends Vertex>> getIsPathDescriptionOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsPathDescriptionOf, Vertex>(this, IsPathDescriptionOf.class, direction);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsExponentiatedPathOf, ? extends Vertex>> getIsExponentiatedPathOfIncidences() {
		return new IncidenceIterable<IsExponentiatedPathOf, Vertex>(this, IsExponentiatedPathOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsExponentiatedPathOf, ? extends Vertex>> getIsExponentiatedPathOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsExponentiatedPathOf, Vertex>(this, IsExponentiatedPathOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsExponentiatedPathOf, ? extends Vertex>> getIsExponentiatedPathOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsExponentiatedPathOf, Vertex>(this, IsExponentiatedPathOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsExponentiatedPathOf, ? extends Vertex>> getIsExponentiatedPathOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsExponentiatedPathOf, Vertex>(this, IsExponentiatedPathOf.class, direction);
	}
	...
	public Iterable<EdgeVertexPair<? extends IsIteratedPathOf, ? extends Vertex>> getIsIteratedPathOfIncidences() {
		return new IncidenceIterable<IsIteratedPathOf, Vertex>(this, IsIteratedPathOf.class);
	}
	
	public Iterable<EdgeVertexPair<? extends IsIteratedPathOf, ? extends Vertex>> getIsIteratedPathOfIncidences(boolean noSubClasses) {
		return new IncidenceIterable<IsIteratedPathOf, Vertex>(this, IsIteratedPathOf.class, noSubClasses);
	}

	public Iterable<EdgeVertexPair<? extends IsIteratedPathOf, ? extends Vertex>> getIsIteratedPathOfIncidences(EdgeDirection direction, boolean noSubClasses) {
		return  new IncidenceIterable<IsIteratedPathOf, Vertex>(this, IsIteratedPathOf.class, direction, noSubClasses);
	}
	
	public Iterable<EdgeVertexPair<? extends IsIteratedPathOf, ? extends Vertex>> getIsIteratedPathOfIncidences(EdgeDirection direction) {
		return new IncidenceIterable<IsIteratedPathOf, Vertex>(this, IsIteratedPathOf.class, direction);
	}
