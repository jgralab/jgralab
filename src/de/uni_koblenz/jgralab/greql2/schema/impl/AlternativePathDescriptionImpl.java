...
public class AlternativePathDescriptionImpl extends VertexImpl implements AlternativePathDescription, Expression, Greql2Vertex, PathDescription, Vertex {

	public AlternativePathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("AlternativePathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return AlternativePathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("AlternativePathDescription doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsAlternativePathOfImpl.class);
	...
	public AlternativePathDescription getNextAlternativePathDescription() {
		return (AlternativePathDescription)getNextVertexOfClass(AlternativePathDescription.class);
	}

	public AlternativePathDescription getNextAlternativePathDescription(boolean noSubClasses) {
		return (AlternativePathDescription)getNextVertexOfClass(AlternativePathDescription.class, noSubClasses);
	}
