...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsElementOfImpl;
...
public class IsElementOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsElementOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsElementOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsElementOf"));
		reversedEdge = new ReversedIsElementOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsElementOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsElementOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsElementOf getNextIsElementOfInGraph() {
		return (IsElementOf)getNextEdgeOfClassInGraph(IsElementOf.class);
	}

	public IsElementOf getNextIsElementOfInGraph(boolean noSubClasses) {
		return (IsElementOf)getNextEdgeOfClassInGraph(IsElementOf.class, noSubClasses);
	}
	...
	public IsElementOf getNextIsElementOf() {
		return (IsElementOf)getNextEdgeOfClass(IsElementOf.class);
	}

	public IsElementOf getNextIsElementOf(EdgeDirection orientation) {
		return (IsElementOf)getNextEdgeOfClass(IsElementOf.class, orientation);
	}

	public IsElementOf getNextIsElementOf(boolean noSubClasses) {
		return (IsElementOf)getNextEdgeOfClass(IsElementOf.class, noSubClasses);
	}

	public IsElementOf getNextIsElementOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsElementOf)getNextEdgeOfClass(IsElementOf.class, orientation, noSubClasses);
	}
