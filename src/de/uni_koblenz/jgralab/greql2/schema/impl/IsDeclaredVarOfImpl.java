...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsDeclaredVarOfImpl;
...
public class IsDeclaredVarOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsDeclaredVarOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsDeclaredVarOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsDeclaredVarOf"));
		reversedEdge = new ReversedIsDeclaredVarOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsDeclaredVarOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsDeclaredVarOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsDeclaredVarOf getNextIsDeclaredVarOfInGraph() {
		return (IsDeclaredVarOf)getNextEdgeOfClassInGraph(IsDeclaredVarOf.class);
	}

	public IsDeclaredVarOf getNextIsDeclaredVarOfInGraph(boolean noSubClasses) {
		return (IsDeclaredVarOf)getNextEdgeOfClassInGraph(IsDeclaredVarOf.class, noSubClasses);
	}
	...
	public IsDeclaredVarOf getNextIsDeclaredVarOf() {
		return (IsDeclaredVarOf)getNextEdgeOfClass(IsDeclaredVarOf.class);
	}

	public IsDeclaredVarOf getNextIsDeclaredVarOf(EdgeDirection orientation) {
		return (IsDeclaredVarOf)getNextEdgeOfClass(IsDeclaredVarOf.class, orientation);
	}

	public IsDeclaredVarOf getNextIsDeclaredVarOf(boolean noSubClasses) {
		return (IsDeclaredVarOf)getNextEdgeOfClass(IsDeclaredVarOf.class, noSubClasses);
	}

	public IsDeclaredVarOf getNextIsDeclaredVarOf(EdgeDirection orientation, boolean noSubClasses) {
		return (IsDeclaredVarOf)getNextEdgeOfClass(IsDeclaredVarOf.class, orientation, noSubClasses);
	}
