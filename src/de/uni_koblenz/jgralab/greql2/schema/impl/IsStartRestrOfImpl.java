...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsStartRestrOfImpl;
...
public class IsStartRestrOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsStartRestrOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsStartRestrOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsStartRestrOf"));
		reversedEdge = new ReversedIsStartRestrOfImpl(this, g);
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsStartRestrOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsStartRestrOf getNextIsStartRestrOfInGraph() {
		return (IsStartRestrOf)getNextEdgeOfClassInGraph(IsStartRestrOf.class);
	}

	public IsStartRestrOf getNextIsStartRestrOfInGraph(boolean noSubClasses) {
		return (IsStartRestrOf)getNextEdgeOfClassInGraph(IsStartRestrOf.class, noSubClasses);
	}
