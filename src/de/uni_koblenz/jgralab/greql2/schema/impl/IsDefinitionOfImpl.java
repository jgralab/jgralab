...
import de.uni_koblenz.jgralab.greql2.schema.impl.ReversedIsDefinitionOfImpl;
...
public class IsDefinitionOfImpl extends AggregationImpl implements Aggregation, Greql2Aggregation, IsDefinitionOf {

	protected java.util.List<SourcePosition> sourcePositions;

	public IsDefinitionOfImpl(int id, Graph g) {
		super(id, g, (AggregationClass)g.getGraphClass().getGraphElementClass("IsDefinitionOf"));
		reversedEdge = new ReversedIsDefinitionOfImpl(this, g);
	}

	public Class<? extends AttributedElement> getM1Class() {
		return IsDefinitionOf.class;
	}
	...
	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		...
		throw new NoSuchFieldException("IsDefinitionOf doesn't contain an attribute " + attributeName);
	}
	...
	public IsDefinitionOf getNextIsDefinitionOfInGraph() {
		return (IsDefinitionOf)getNextEdgeOfClassInGraph(IsDefinitionOf.class);
	}

	public IsDefinitionOf getNextIsDefinitionOfInGraph(boolean noSubClasses) {
		return (IsDefinitionOf)getNextEdgeOfClassInGraph(IsDefinitionOf.class, noSubClasses);
	}
