...
public class BackwardVertexSetImpl extends VertexImpl implements BackwardVertexSet, Expression, Greql2Vertex, PathExpression, Vertex {

	public BackwardVertexSetImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("BackwardVertexSet"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return BackwardVertexSet.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("BackwardVertexSet doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsPathOfImpl.class);

		validToEdges.add(IsStartExprOfImpl.class);

		validToEdges.add(IsTargetExprOfImpl.class);

	}

	public BackwardVertexSet getNextBackwardVertexSet() {
		return (BackwardVertexSet)getNextVertexOfClass(BackwardVertexSet.class);
	}

	public BackwardVertexSet getNextBackwardVertexSet(boolean noSubClasses) {
		return (BackwardVertexSet)getNextVertexOfClass(BackwardVertexSet.class, noSubClasses);
	}
	...
	public PathExpression getNextPathExpression() {
		return (PathExpression)getNextVertexOfClass(PathExpression.class);
	}
