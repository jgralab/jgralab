...
public class FunctionIdImpl extends VertexImpl implements Expression, FunctionId, Greql2Vertex, Identifier, Vertex {

	protected String name;

	public FunctionIdImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("FunctionId"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return FunctionId.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		if (attributeName.equals("name")) return name;
		throw new NoSuchFieldException("FunctionId doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validFromEdges.add(IsFunctionIdOfImpl.class);
	...
	public FunctionId getNextFunctionId() {
		return (FunctionId)getNextVertexOfClass(FunctionId.class);
	}

	public FunctionId getNextFunctionId(boolean noSubClasses) {
		return (FunctionId)getNextVertexOfClass(FunctionId.class, noSubClasses);
	}
