...
public class TransposedPathDescriptionImpl extends VertexImpl implements Expression, Greql2Vertex, PathDescription, TransposedPathDescription, Vertex {

	public TransposedPathDescriptionImpl(int id, Graph g) {
		super(id, g, (VertexClass)g.getGraphClass().getGraphElementClass("TransposedPathDescription"));
	}

	public Class<? extends AttributedElement> getM1Class() {
		return TransposedPathDescription.class;
	}

	public Object getAttribute(String attributeName) throws NoSuchFieldException {
		throw new NoSuchFieldException("TransposedPathDescription doesn't contain an attribute " + attributeName);
	}
	...
	
	{
		...
		validToEdges.add(IsTransposedPathOfImpl.class);
	...
	public TransposedPathDescription getNextTransposedPathDescription() {
		return (TransposedPathDescription)getNextVertexOfClass(TransposedPathDescription.class);
	}

	public TransposedPathDescription getNextTransposedPathDescription(boolean noSubClasses) {
		return (TransposedPathDescription)getNextVertexOfClass(TransposedPathDescription.class, noSubClasses);
	}
