...
import de.uni_koblenz.jgralab.greql2.schema.impl.VertexSetExpressionImpl;

public interface VertexSetExpression extends ElementSetExpression, Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<VertexSetExpressionImpl> IMPLEMENTATION_CLASS = VertexSetExpressionImpl.class;

	/**
	 * @return the next ElementSetExpression vertex in the global vertex sequence
	 */
	...
	/**
	 * @return the next VertexSetExpression vertex in the global vertex sequence
	 */
