...
import de.uni_koblenz.jgralab.greql2.schema.impl.EdgeSetExpressionImpl;

public interface EdgeSetExpression extends ElementSetExpression, Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<EdgeSetExpressionImpl> IMPLEMENTATION_CLASS = EdgeSetExpressionImpl.class;

	/**
	 * @return the next EdgeSetExpression vertex in the global vertex sequence
	 */
