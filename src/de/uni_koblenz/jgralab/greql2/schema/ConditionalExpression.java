...
import de.uni_koblenz.jgralab.greql2.schema.impl.ConditionalExpressionImpl;

public interface ConditionalExpression extends Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<ConditionalExpressionImpl> IMPLEMENTATION_CLASS = ConditionalExpressionImpl.class;

	/**
	 * @return the next ConditionalExpression vertex in the global vertex sequence
	 */
