...
import de.uni_koblenz.jgralab.greql2.schema.impl.EdgeSubgraphExpressionImpl;

public interface EdgeSubgraphExpression extends Expression, Greql2Vertex, SubgraphExpression, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<EdgeSubgraphExpressionImpl> IMPLEMENTATION_CLASS = EdgeSubgraphExpressionImpl.class;

	/**
	 * @return the next EdgeSubgraphExpression vertex in the global vertex sequence
	 */
