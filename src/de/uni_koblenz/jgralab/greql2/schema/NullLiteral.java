...
import de.uni_koblenz.jgralab.greql2.schema.impl.NullLiteralImpl;

public interface NullLiteral extends Expression, Greql2Vertex, Literal, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<NullLiteralImpl> IMPLEMENTATION_CLASS = NullLiteralImpl.class;
	...
	/**
	 * @return the next NullLiteral vertex in the global vertex sequence
	 */
