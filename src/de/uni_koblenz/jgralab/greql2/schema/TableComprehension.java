...
import de.uni_koblenz.jgralab.greql2.schema.impl.TableComprehensionImpl;

public interface TableComprehension extends Comprehension, ComprehensionWithTableHeader, Expression, Greql2Vertex, Vertex {

	/**
	 * refers to the default implementation class of this interface
	 */
	public static final Class<TableComprehensionImpl> IMPLEMENTATION_CLASS = TableComprehensionImpl.class;

	/**
	 * @return the next Comprehension vertex in the global vertex sequence
	 */
	public Comprehension getNextComprehension();

	/**
	 * @return the next ComprehensionWithTableHeader vertex in the global vertex sequence
	 */
	...
	/**
	 * @return the next TableComprehension vertex in the global vertex sequence
	 */
