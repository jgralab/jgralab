...
public class GraphDatabase {
	...
	public void applyGenericDatabaseSchema() throws GraphDatabaseException {
		try {
			...
			PreparedStatement statement = this.sqlStatementList.createGraphSchemaTable();
			statement.execute();
			...
			//statement = this.sqlStatementList.addPrimaryKeyConstraintOnVertexTable();
			//statement.execute();
			...
			throw new GraphDatabaseException("Could not apply schema to database.", exception);
		}
	}
	...
	public void optimizeForWrite() {
		try {
			if(this.sqlStatementList instanceof PostgreSqlStatementList){
				PreparedStatement statement = this.sqlStatementList.dropForeignKeyConstraintFromVertexTable();
				statement.execute();
				statement = this.sqlStatementList.dropForeignKeyConstraintFromEdgeTable();
				statement.execute();
				statement = this.sqlStatementList.dropClusteredIndicesOnAttributeValues(); // TODO split into three
				statement.execute();
				statement = this.sqlStatementList.dropForeignKeyConstraintsFromIncidenceTable();
				statement.execute();
				statement = this.sqlStatementList.dropForeignKeyConstraintsFromVertexAttributeValueTable();
				statement.execute();
				statement = this.sqlStatementList.dropForeignKeyConstraintsFromEdgeAttributeValueTable();
				statement.execute();
				statement = this.sqlStatementList.dropPrimaryKeyConstraintFromVertexAttributeValueTable();
				statement.execute();
	...
	public void optimizeForRead() {
		try {
			...
			if(this.sqlStatementList instanceof MySqlStatementList){
				PreparedStatement statement = this.connection.prepareStatement("ALTER IGNORE TABLE Incidence DROP INDEX lambdaSeqIndex;");
				statement.execute();
				statement = this.connection.prepareStatement("ALTER IGNORE TABLE GraphAttributeValue DROP INDEX graphAttributeValueIndex;");
				statement.execute();
				statement = this.connection.prepareStatement("ALTER IGNORE TABLE VertexAttributeValue DROP INDEX vertexAttributeValueIndex;");
				statement.execute();
				statement = this.connection.prepareStatement("ALTER IGNORE TABLE EdgeAttributeValue DROP INDEX edgeAttributeValueIndex;");
				statement.execute();				
			}
			*/
			...
			if(this.sqlStatementList instanceof PostgreSqlStatementList){
				...
				//statement = this.sqlStatementList.addClusteredIndexOnEdgeAttributeValues();
				//statement.execute();				
				//statement = this.sqlStatementList.addForeignKeyConstraintsOnVertexTable();
				//statement.execute();
				//statement = this.sqlStatementList.addForeignKeyConstraintsOnEdgeTable();
				//statement.execute();
				//statement = this.sqlStatementList.addForeignKeyConstraintsOnIncidenceTable();
				//statement.execute();
				//statement = this.sqlStatementList.addForeignKeyConstraintsOnVertexAttributeValueTable();
				//statement.execute();
				//statement = this.sqlStatementList.addForeignKeyConstraintsOnEdgeAttributeValueTable();
				//statement.execute();				
				//this.cluster();
			}
		}
	...
	private void cluster() throws SQLException {
		PreparedStatement clusterIncidencesStatement = this.sqlStatementList.clusterIncidences();
		clusterIncidencesStatement.execute();
		PreparedStatement clusterStatement = this.sqlStatementList.clusterAttributeValues();
