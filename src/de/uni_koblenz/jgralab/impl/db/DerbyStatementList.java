...
public class DerbyStatementList extends SqlStatementList {
	...
	private String STORED_PROCEDURE_REORGANIZE_VERTEX_LIST = "CREATE FUNCTION \"reorganizeVertexListOf\"(\"graphId\" INT, median BIGINT) RETURNS INT AS $$\n"
			+ "DECLARE\n"
	...
	private String STORED_PROCEDURE_REORGANIZE_EDGE_LIST = "CREATE FUNCTION \"reorganizeEdgeListOf\"(\"graphId\" INT, median BIGINT) RETURNS INT AS $$\n"
			+ "DECLARE\n"
			+ "distance BIGINT := 4294967296;\n"
			+ "current BIGINT := 0;\n"
			+ "edge RECORD;\n"
	...
	private String STORED_PROCEDURE_REORGANIZE_INCIDENCE_LIST = "CREATE FUNCTION \"reorganizeIncidenceListOf\"(\"vertexId\" INT, \"graphId\" INT, median BIGINT) RETURNS INT AS $$\n"
			+ "DECLARE\n"
			+ "distance BIGINT := 4294967296;\n"
			+ "current BIGINT := 0;\n"
			+ "incidence RECORD;\n"
