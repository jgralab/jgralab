...
public abstract class Tracker {
	...
	/**
	 * The amount of memory in bytes a Vertex, sans its attributes,
	 * needs on the disk
	 */
	 ...
	 * 
	 * For an Edge, the indexes are:
	 *  0 - EdgeClassId
	 *  4 - nextElementId
	 * 12 - previousElementId
	 * 20 - nextIncidenceId
	 * 28 - previousIncidenceId
	 * 36 - incidentVertexId
	 * 44 - nextIncidenceReversedId
	 * 52 - previousIncidenceReversedId
	 * 60 - incidentVertexReversedId
	 * 
	 * For a Vertex, the indexes are:
	 *  0 - VertexClassId
	 *  4 - nextElementId
	 * 12 - previousElementId
	 * 20 - firstIncidenceId
	...
	protected abstract void storeVariables(GraphElementImpl<?,?> ge); 
	...
	public void storeAttributes(GraphElementImpl<?,?> ge){
		storeVariables(ge);
		int typeId = ge.getAttributedElementClass().getGraphElementClassIdInSchema();
