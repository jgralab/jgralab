 ...
 * using the methods <code>edges(params)</code> of th graph.
 * Every special graphclass contains generated methods similar to <code>edges(params)</code>
 * for every EdgeClass that is part of the GraphClass.
 *   
 * @author Daniel Bildhauer <dbildh@uni-koblenz.de>
 *
 * @param <E> The type of the Edges to iterate over. To mention it again, <b>don't</b> create
...
public class EdgeIterable<E extends Edge> implements Iterable<E> {
	...
	class EdgeIteratorClassExplicit extends EdgeIterator {
		...
		public EdgeIteratorClassExplicit(Graph g, Class<? extends Edge> c, boolean type) {
			super(g);
			this.type = type;
			ec = c;
		}
	...
	private EdgeIterator iter = null;
	...
	public EdgeIterable(Graph g, EdgeClass ec) {
		iter = new EdgeIteratorEdgeClassExplicit(g, ec, false);
	}
	...
	public EdgeIterable(Graph g, EdgeClass ec, boolean explicitType) {
		iter = new EdgeIteratorEdgeClassExplicit(g, ec, explicitType);
	}
	
	public EdgeIterable(Graph g, Class<? extends Edge> ec, boolean explicitType) {
		iter = new EdgeIteratorClassExplicit(g, ec, explicitType);
	}
