...
public class FirstOut extends FirstFunction {

	public FirstOut() {
		super(EdgeDirection.OUT);
	}

	@Description(params = "v", description = "Returns the first outgoing edge of vertex v.", categories = Category.GRAPH)
	@Override
	...
	@Description(params = { "v", "c" }, description = "Returns the first outgoing edge of vertex v.\n"
