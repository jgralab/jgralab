...
public class NextIn extends NextFunction {

	public NextIn() {
		super(EdgeDirection.IN);
	}

	@Description(params = "e", description = "Returns the next incoming edge following e in incidence order.", categories = Category.GRAPH)
	@Override
	public Edge evaluate(Edge e) {
		return super.evaluate(e);
	}

	@Description(params = { "e", "c" }, description = "Returns the next incoming edge following e in incidence order.\n"
