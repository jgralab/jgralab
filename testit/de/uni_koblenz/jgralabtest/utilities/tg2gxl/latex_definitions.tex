...
\lstdefinelanguage{greql2}{
 morekeywords={using, from, end, with, report, reportList, reportSet, reportMap,
 in, forall, exists!, exists, as,
 list, set, rec, path, pathsystem, thisVertex, thisEdge, thisGraph,
 not, tup, and, andThen, or, orElse, xor, V, E, eSubgraph, vSubgraph,
 let, where, store },
 sensitive=true,
 morecomment=[l]{//},
 morecomment=[n]{/*}{*/},
