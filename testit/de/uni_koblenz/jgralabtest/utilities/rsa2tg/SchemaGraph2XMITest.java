...
public class SchemaGraph2XMITest {
    ...
    public static void setUp() {
        ...
        temp = new File(System.getProperty("java.io.tmpdir") + File.separator + "SchemaGraph2XMI_TestOutput");
        if (!temp.exists()) {
            if (!temp.mkdir()) {
     ...
     */
    @Test
    public void testDefault() throws GraphIOException, FileNotFoundException, XMLStreamException {
        runTests(false);
    }
     ...
     */
    @Test
    public void testBidirectional() throws GraphIOException, FileNotFoundException, XMLStreamException {
        runTests(true);
    }

    private void runTests(boolean createBidirectional)
            ...
            for (String file : filenames) {
                if (file.toLowerCase()
                    ...
                    if (createBidirectional) {
                        SchemaGraph2XMI.main(new String[] { "-i", originalTg, "-o", generatedXMI, "-b" });
                    } else {
                        SchemaGraph2XMI.main(new String[] { "-i", originalTg, "-o", generatedXMI });
                    }
