...
public class BuildTg2Dot {
	final static String[] testgrumlschema = { "GrumlSchema.tg", "testgrumlgraph" };
	...
	public static void convert(String[] args) {
		...
		tg2sgargs[0] = "-s";
		tg2sgargs[1] = "testit/de/uni_koblenz/jgralabtest/tg2schemagraphtest/"
				+ args[0];
		tg2sgargs[2] = "-o";
		tg2sgargs[3] = "testit/de/uni_koblenz/jgralabtest/tg2schemagraphtest/"
				+ args[1] + ".tg";
		Tg2SchemaGraph.main(tg2sgargs);
		String[] tg2dargs = new String[4];
		tg2dargs[0] = "-g";
		tg2dargs[1] = "testit/de/uni_koblenz/jgralabtest/tg2schemagraphtest/"
				+ args[1] + ".tg";
		tg2dargs[2] = "-o";
		tg2dargs[3] = "testit/de/uni_koblenz/jgralabtest/tg2schemagraphtest/"
				+ args[1] + ".dot";
