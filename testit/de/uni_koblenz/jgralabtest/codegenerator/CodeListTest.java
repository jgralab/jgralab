...
public class CodeListTest {
	...
	public void testCodeList2() {
		...
		// no matter what cl1 contains, the usage of the constructor will always
		// result
		// in an empty CodeList => getSize() will always return 0, getCode
		// always an empty
		// String
		assertEquals(0, cl2.size());
		assertEquals("", cl2.getCode());
	...
	public void testRemove() {
		...
		CodeSnippet cs3 = new CodeSnippet("Großbritannien", "", "Wales",
		...
		ics1.add("Westeuropa.Frankreich", "Südeuropa.Spanien",
				"Südeuropa.Portugal");
		ImportCodeSnippet ics2 = new ImportCodeSnippet();
		ics2.add("Südeuropa.Italien", "Mitteleuropa.Österreich",
		...
		// border cases
		// tests if it works to remove sth. which is not part of the CodeList
		// anymore
		cl.add(cs2);
		cl.remove(cs1);
		assertEquals("\tDänemark\n\tIsland\n", cl.getCode());
	...
	public void testAddNoIndent() {
		// normal cases
		CodeList cl1 = new CodeList();
		CodeSnippet cs1 = new CodeSnippet("Spanien", "Portugal", "",
				"Frankreich");
	...
	public void testGetCode() {
		...
		assertEquals("\t\t\t\t\t\t\tNiederlande\n\t\t\t\t\t\t\tBelgien\n"
				+ "\t\t\t\t\t\t\tLuxemburg\n", cl1.getCode(6));
		CodeSnippet cs2 = new CodeSnippet("Schweiz", "", "Liechtenstein",
				"Österreich");
		cl1.add(cs2, 3);
		assertEquals(
				"\t\t\tNiederlande\n\t\t\tBelgien\n\t\t\tLuxemburg\n"
	...
	public void testGetCode2() {
		...
		assertEquals("\n\timport Afrika.;\n\t\n\timport Fluss.Afrika.Nil;\n",
				cl.getCode());
		ics.add("Land.Afrika.Südafrika", "Land.Afrika.Zaire", "Afrika.",
				"Land.Afrika.Ghana");
		assertEquals(
				"\n\timport Afrika.;\n\t\n\timport Fluss.Afrika.Nil;\n\t\n\timport "
	...
	public void testSize() {
		...
		CodeSnippet cs3 = new CodeSnippet("September", "October", "November",
				"December");
		cl.add(cs2);
