...
public class CodeSnippetTest { 
	...
	public void testCodeSnippet3(){
		//normal cases
		CodeSnippet cs=new CodeSnippet(true, "Erdbeere", "Blaubeere", "Himbeere");
		assertEquals("\nErdbeere\nBlaubeere\nHimbeere\n", cs.getCode());
	...
	public void testCodeSnippet4(){		
		...
		assertEquals("\t\t\tAnanas\n\tMango\n\tAvocado\n", cl.getCode());
		cl.clear();
		cs1=new CodeSnippet(cl, "Mandarine", "Orange", "Grapefruit", "Pampelmuse");
	...
	public void testAdd(){
		//normal cases
		CodeSnippet cs=new CodeSnippet();
		cs.add("Schokolade", "Pfefferminzbonbon", "Brausepulver", "Schokoriegel");
	...
	public void testGetCode2(){
		...
		cs=new CodeSnippet("", "azurblau", "meergrün", "preußischblau", "", "", "ultramarin");
		assertEquals("\nazurblau\nmeergrün\npreußischblau\n\n\nultramarin\n", cs.getCode());
	...
	public void testGetParent(){
		...
		assertEquals("0", cs.getParent().getParent().getParent().getVariable("parent1"));
		assertEquals("*UNDEFINED:parent4*", cs.getParent().getParent().getParent().getVariable("parent4"));
		assertEquals(null, cs.getParent().getParent().getParent().getParent());
	}
}
