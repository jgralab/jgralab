...
public class RoleNameTest extends InstanceTest {
    ...
    public void setUp() {
        ...
        case STANDARD:
            graph = VertexTestSchema.instance()
                    .createVertexTestGraph(ImplementationType.STANDARD);
            break;
        default:
     ...
     * @param v9Inci
     */
    private void testIncidences(A v1, C v2, B v3, D v4, B v5, D v6, A v7, C v8, LinkedList<Edge> v1Inci,
            LinkedList<Edge> v2Inci, LinkedList<Edge> v3Inci, LinkedList<Edge> v4Inci, LinkedList<Edge> v5Inci,
            LinkedList<Edge> v6Inci, LinkedList<Edge> v7Inci, LinkedList<Edge> v8Inci) {
        testIncidences(v1, v2, v3, v4, v5, v6, v7, v8, null, null, null, null, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci,
     ...
     * @param v12Inci
     */
    private void testIncidences(A v1, C v2, B v3, D v4, B v5, D v6, A v7, C v8, C2 v9, C2 v10, D2 v11, D2 v12,
            LinkedList<Edge> v1Inci, LinkedList<Edge> v2Inci, LinkedList<Edge> v3Inci, LinkedList<Edge> v4Inci,
            LinkedList<Edge> v5Inci, LinkedList<Edge> v6Inci, LinkedList<Edge> v7Inci, LinkedList<Edge> v8Inci,
            LinkedList<Edge> v9Inci, LinkedList<Edge> v10Inci, LinkedList<Edge> v11Inci, LinkedList<Edge> v12Inci) {
     ...
     * @param incidentLists
     */
    private void deleteRandomEdges(LinkedList<Edge> v1Inci, LinkedList<Edge> v2Inci, LinkedList<Edge> v3Inci,
            LinkedList<Edge> v4Inci, LinkedList<Edge> v5Inci, LinkedList<Edge> v6Inci, LinkedList<Edge> v7Inci,
            LinkedList<Edge> v8Inci) {
        deleteRandomEdges(v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci, v8Inci, null, null, null, null);
    }
    ...
    private void deleteRandomEdges(LinkedList<Edge> v1Inci, LinkedList<Edge> v2Inci, LinkedList<Edge> v3Inci,
            LinkedList<Edge> v4Inci, LinkedList<Edge> v5Inci, LinkedList<Edge> v6Inci, LinkedList<Edge> v7Inci,
            LinkedList<Edge> v8Inci, LinkedList<Edge> v9Inci, LinkedList<Edge> v10Inci, LinkedList<Edge> v11Inci,
    ...
    /**
     * Creates a randomGraph with four vertices and 1000 edges. The incident edges
     * for each vertex are saved in the corresponding LinkedList.
     *
     * @param useAddTarget true: addTargetRoleName is used, false: addSourceRoleName
     *        is used
     * @param v1
     * @param v2
     * @param v3
     ...
     * @param v8Inci
     */
    private void createRandomGraph(boolean useAddTarget, A v1, C v2, B v3, D v4, B v5, D v6, A v7, C v8,
            LinkedList<Edge> v1Inci, LinkedList<Edge> v2Inci, LinkedList<Edge> v3Inci, LinkedList<Edge> v4Inci,
            LinkedList<Edge> v5Inci, LinkedList<Edge> v6Inci, LinkedList<Edge> v7Inci, LinkedList<Edge> v8Inci) {
        createRandomGraph(useAddTarget, v1, v2, v3, v4, v5, v6, v7, v8, null, null, null, null, v1Inci, v2Inci, v3Inci,
                v4Inci, v5Inci, v6Inci, v7Inci, v8Inci, null, null, null, null);
    }
     ...
     * @param v12Inci
     */
    private void createRandomGraph(boolean useAddTarget, A v1, C v2, B v3, D v4, B v5, D v6, A v7, C v8, C2 v9, C2 v10,
            D2 v11, D2 v12, LinkedList<Edge> v1Inci, LinkedList<Edge> v2Inci, LinkedList<Edge> v3Inci,
            LinkedList<Edge> v4Inci, LinkedList<Edge> v5Inci, LinkedList<Edge> v6Inci, LinkedList<Edge> v7Inci,
            LinkedList<Edge> v8Inci, LinkedList<Edge> v9Inci, LinkedList<Edge> v10Inci, LinkedList<Edge> v11Inci,
            LinkedList<Edge> v12Inci) {
        for (int i = 0; i < 1000; i++) {
            ...
            if (whichEdge == 0) {
                ...
                switch (end) {
                case 0:
                    e = howToCreate == 0 ? graph.createE(start == 0 ? v1 : v7, v3)
                            : useAddTarget ? (start == 0 ? v1 : v7).add_x(v3) : v3.add_sourceE(start == 0 ? v1 : v7);
                    (start == 0 ? v1Inci : v7Inci).add(e);
                    v3Inci.add(e.getReversedEdge());
                    break;
                case 1:
                    e = howToCreate == 0 ? graph.createE(start == 0 ? v1 : v7, v4)
                            : useAddTarget ? (start == 0 ? v1 : v7).add_x(v4) : v4.add_sourceE(start == 0 ? v1 : v7);
                    (start == 0 ? v1Inci : v7Inci).add(e);
                    v4Inci.add(e.getReversedEdge());
                    break;
                case 2:
                    e = howToCreate == 0 ? graph.createE(start == 0 ? v1 : v7, v5)
                            : useAddTarget ? (start == 0 ? v1 : v7).add_x(v5) : v5.add_sourceE(start == 0 ? v1 : v7);
                    (start == 0 ? v1Inci : v7Inci).add(e);
                    v5Inci.add(e.getReversedEdge());
                    break;
                case 3:
                    e = howToCreate == 0 ? graph.createE(start == 0 ? v1 : v7, v6)
                            : useAddTarget ? (start == 0 ? v1 : v7).add_x(v6) : v6.add_sourceE(start == 0 ? v1 : v7);
                    (start == 0 ? v1Inci : v7Inci).add(e);
                ...
                switch (end) {
                case 0:
                    e = howToCreate == 0 ? graph.createF(start == 0 ? v2 : v8, v4)
                            : useAddTarget ? (start == 0 ? v2 : v8).add_y(v4) : v4.add_sourceF(start == 0 ? v2 : v8);
                    (start == 0 ? v2Inci : v8Inci).add(e);
                    v4Inci.add(e.getReversedEdge());
                    break;
                case 1:
                    e = howToCreate == 0 ? graph.createF(start == 0 ? v2 : v8, v6)
                            : useAddTarget ? (start == 0 ? v2 : v8).add_y(v6) : v6.add_sourceF(start == 0 ? v2 : v8);
                    (start == 0 ? v2Inci : v8Inci).add(e);
                    v6Inci.add(e.getReversedEdge());
                    break;
                }
                ...
                switch (end) {
                case 0:
                    e = howToCreate == 0 ? graph.createG(start == 0 ? v2 : v8, v4)
                            : useAddTarget ? (start == 0 ? v2 : v8).add_z(v4) : v4.add_sourceG(start == 0 ? v2 : v8);
                    (start == 0 ? v2Inci : v8Inci).add(e);
                    v4Inci.add(e.getReversedEdge());
                    break;
                case 1:
                    e = howToCreate == 0 ? graph.createG(start == 0 ? v2 : v8, v6)
                            : useAddTarget ? (start == 0 ? v2 : v8).add_z(v6) : v6.add_sourceG(start == 0 ? v2 : v8);
                    (start == 0 ? v2Inci : v8Inci).add(e);
                    v6Inci.add(e.getReversedEdge());
                    break;
                }
                ...
                case 0:
                    switch (start) {
                    case 0:
                        e = howToCreate == 0 ? graph.createH(v1, v3) : useAddTarget ? v1.add_w(v3) : v3.add_sourceH(v1);
                        v1Inci.add(e);
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createH(v2, v3) : useAddTarget ? v2.add_w(v3) : v3.add_sourceH(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        e = howToCreate == 0 ? graph.createH(v7, v3) : useAddTarget ? v7.add_w(v3) : v3.add_sourceH(v7);
                        v7Inci.add(e);
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createH(v8, v3) : useAddTarget ? v8.add_w(v3) : v3.add_sourceH(v8);
                        v8Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createH(v9, v3) : useAddTarget ? v9.add_w(v3) : v3.add_sourceH(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createH(v10, v3)
                                : useAddTarget ? v10.add_w(v3) : v3.add_sourceH(v10);
                        v10Inci.add(e);
                        break;
                    }
                    if (e != null) {
                ...
                case 1:
                    switch (start) {
                    case 0:
                        e = howToCreate == 0 ? graph.createH(v1, v4) : useAddTarget ? v1.add_w(v4) : v4.add_sourceH(v1);
                        v1Inci.add(e);
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createH(v2, v4) : useAddTarget ? v2.add_w(v4) : v4.add_sourceH(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        e = howToCreate == 0 ? graph.createH(v7, v4) : useAddTarget ? v7.add_w(v4) : v4.add_sourceH(v7);
                        v7Inci.add(e);
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createH(v8, v4) : useAddTarget ? v8.add_w(v4) : v4.add_sourceH(v8);
                        v8Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createH(v9, v4) : useAddTarget ? v9.add_w(v4) : v4.add_sourceH(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createH(v10, v4)
                                : useAddTarget ? v10.add_w(v4) : v4.add_sourceH(v10);
                        v10Inci.add(e);
                        break;
                    }
                    v4Inci.add(e.getReversedEdge());
                ...
                case 2:
                    switch (start) {
                    case 0:
                        e = howToCreate == 0 ? graph.createH(v1, v5) : useAddTarget ? v1.add_w(v5) : v5.add_sourceH(v1);
                        v1Inci.add(e);
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createH(v2, v5) : useAddTarget ? v2.add_w(v5) : v5.add_sourceH(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        e = howToCreate == 0 ? graph.createH(v7, v5) : useAddTarget ? v7.add_w(v5) : v5.add_sourceH(v7);
                        v7Inci.add(e);
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createH(v8, v5) : useAddTarget ? v8.add_w(v5) : v5.add_sourceH(v8);
                        v8Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createH(v9, v5) : useAddTarget ? v9.add_w(v5) : v5.add_sourceH(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createH(v10, v5)
                                : useAddTarget ? v10.add_w(v5) : v5.add_sourceH(v10);
                        v10Inci.add(e);
                        break;
                    }
                    if (e != null) {
                ...
                case 3:
                    switch (start) {
                    case 0:
                        e = howToCreate == 0 ? graph.createH(v1, v6) : useAddTarget ? v1.add_w(v6) : v6.add_sourceH(v1);
                        v1Inci.add(e);
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createH(v2, v6) : useAddTarget ? v2.add_w(v6) : v6.add_sourceH(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        e = howToCreate == 0 ? graph.createH(v7, v6) : useAddTarget ? v7.add_w(v6) : v6.add_sourceH(v7);
                        v7Inci.add(e);
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createH(v8, v6) : useAddTarget ? v8.add_w(v6) : v6.add_sourceH(v8);
                        v8Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createH(v9, v6) : useAddTarget ? v9.add_w(v6) : v6.add_sourceH(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createH(v10, v6)
                                : useAddTarget ? v10.add_w(v6) : v6.add_sourceH(v10);
                        v10Inci.add(e);
                        break;
                    }
                    v6Inci.add(e.getReversedEdge());
                ...
                case 4:
                    ...
                    case 0:
                        e = howToCreate == 0 ? graph.createH(v1, v11)
                                : useAddTarget ? v1.add_w(v11) : v11.add_sourceH(v1);
                        v1Inci.add(e);
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createH(v2, v11)
                                : useAddTarget ? v2.add_w(v11) : v11.add_sourceH(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        e = howToCreate == 0 ? graph.createH(v7, v11)
                                : useAddTarget ? v7.add_w(v11) : v11.add_sourceH(v7);
                        v7Inci.add(e);
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createH(v8, v11)
                                : useAddTarget ? v8.add_w(v11) : v11.add_sourceH(v8);
                        v8Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createH(v9, v11)
                                : useAddTarget ? v9.add_w(v11) : v11.add_sourceH(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createH(v10, v11)
                                : useAddTarget ? v10.add_w(v11) : v11.add_sourceH(v10);
                        v10Inci.add(e);
                        break;
                    }
                ...
                case 5:
                    ...
                    case 0:
                        e = howToCreate == 0 ? graph.createH(v1, v12)
                                : useAddTarget ? v1.add_w(v12) : v12.add_sourceH(v1);
                        v1Inci.add(e);
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createH(v2, v12)
                                : useAddTarget ? v2.add_w(v12) : v12.add_sourceH(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        e = howToCreate == 0 ? graph.createH(v7, v12)
                                : useAddTarget ? v7.add_w(v12) : v12.add_sourceH(v7);
                        v7Inci.add(e);
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createH(v8, v12)
                                : useAddTarget ? v8.add_w(v12) : v12.add_sourceH(v8);
                        v8Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createH(v9, v12)
                                : useAddTarget ? v9.add_w(v12) : v12.add_sourceH(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createH(v10, v12)
                                : useAddTarget ? v10.add_w(v12) : v12.add_sourceH(v10);
                        v10Inci.add(e);
                        break;
                    }
                ...
                case 0:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createI(v9, v1) : useAddTarget ? v9.add_v(v1) : v1.add_sourceI(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createI(v10, v1)
                                : useAddTarget ? v10.add_v(v1) : v1.add_sourceI(v10);
                        v10Inci.add(e);
                        break;
                    }
                    if (e != null) {
                ...
                case 1:
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createI(v2, v2) : useAddTarget ? v2.add_v(v2) : v2.add_sourceI(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        ...
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createI(v8, v2) : useAddTarget ? v8.add_v(v2) : v2.add_sourceI(v8);
                        v8Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createI(v9, v2) : useAddTarget ? v9.add_v(v2) : v2.add_sourceI(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createI(v10, v2)
                                : useAddTarget ? v10.add_v(v2) : v2.add_sourceI(v10);
                        v10Inci.add(e);
                        break;
                    }
                    if (e != null) {
                ...
                case 2:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createI(v9, v7) : useAddTarget ? v9.add_v(v7) : v7.add_sourceI(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createI(v10, v7)
                                : useAddTarget ? v10.add_v(v7) : v7.add_sourceI(v10);
                        v10Inci.add(e);
                        break;
                    }
                ...
                case 4:
                    switch (start) {
                    case 0:
                        e = howToCreate == 0 ? graph.createI(v1, v9) : useAddTarget ? v1.add_v(v9) : v9.add_sourceI(v1);
                        v1Inci.add(e);
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createI(v2, v9) : useAddTarget ? v2.add_v(v9) : v9.add_sourceI(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        e = howToCreate == 0 ? graph.createI(v9, v9) : useAddTarget ? v9.add_v(v9) : v9.add_sourceI(v9);
                        v9Inci.add(e);
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createI(v8, v9) : useAddTarget ? v8.add_v(v9) : v9.add_sourceI(v8);
                        v8Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createI(v9, v9) : useAddTarget ? v9.add_v(v9) : v9.add_sourceI(v9);
                    ...
                    case 5:
                        e = howToCreate == 0 ? graph.createI(v10, v9)
                                : useAddTarget ? v10.add_v(v9) : v9.add_sourceI(v10);
                        v10Inci.add(e);
                        break;
                    }
                    if (e != null) {
                ...
                case 5:
                    ...
                    case 0:
                        e = howToCreate == 0 ? graph.createI(v1, v10)
                                : useAddTarget ? v1.add_v(v10) : v10.add_sourceI(v1);
                        v1Inci.add(e);
                        break;
                    case 1:
                        e = howToCreate == 0 ? graph.createI(v2, v10)
                                : useAddTarget ? v2.add_v(v10) : v10.add_sourceI(v2);
                        v2Inci.add(e);
                        break;
                    case 2:
                        e = howToCreate == 0 ? graph.createI(v7, v10)
                                : useAddTarget ? v7.add_v(v10) : v10.add_sourceI(v7);
                        v7Inci.add(e);
                        break;
                    case 3:
                        e = howToCreate == 0 ? graph.createI(v10, v10)
                                : useAddTarget ? v10.add_v(v10) : v10.add_sourceI(v10);
                        v10Inci.add(e);
                        break;
                    case 4:
                        e = howToCreate == 0 ? graph.createI(v9, v10)
                                : useAddTarget ? v9.add_v(v10) : v10.add_sourceI(v9);
                        v9Inci.add(e);
                        break;
                    case 5:
                        e = howToCreate == 0 ? graph.createI(v10, v10)
                ...
                switch (end) {
                case 0:
                    e = howToCreate == 0 ? graph.createJ(start == 0 ? v9 : v10, v11)
                            : useAddTarget ? (start == 0 ? v9 : v10).add_u(v11)
                                    : v11.add_sourceJ(start == 0 ? v9 : v10);
                    (start == 0 ? v9Inci : v10Inci).add(e);
                    v11Inci.add(e.getReversedEdge());
                    break;
                case 1:
                    e = howToCreate == 0 ? graph.createJ(start == 0 ? v9 : v10, v12)
                            : useAddTarget ? (start == 0 ? v9 : v10).add_u(v12)
                                    : v12.add_sourceJ(start == 0 ? v9 : v10);
                    (start == 0 ? v9Inci : v10Inci).add(e);
                    v12Inci.add(e.getReversedEdge());
                    break;
                }
    ...
    private I doMagic(boolean useAddTarget, A v1, A v8, LinkedList<Edge> v1Inci, int howToCreate) {
        I e;
        e = howToCreate == 0 ? graph.createI(v1, v8) : useAddTarget ? v1.add_v(v8) : v8.add_sourceI(v1);
        v1Inci.add(e);
        return e;
    }
     ...
     * <code>rolenames</code>.
     *
     * @param useTarget true: <code>rolenames</code> are target rolenames, false:
     ...
     * @param inciTo
     */
    private void deleteAll(boolean useTarget, Vertex from, Vertex to, LinkedList<Edge> inciFrom,
            LinkedList<Edge> inciTo, String... rolenames) {
        for (int i = 0; i < inciFrom.size(); i++) {
            Edge e = inciFrom.get(i)
                    .getNormalEdge();
            if (e.getAlpha() == from && e.getOmega() == to
                    && checkRoleName(useTarget ? e.getThatRole() : e.getThisRole(), rolenames)) {
                inciFrom.remove(i--);
            }
        }
     ...
     *
     * @param inci list of incident Edges of one node
     * @param rolenames
     * @return LinkedList&ltVertex&gt which contains the relevant edges
     */
    private LinkedList<Vertex> getAllVerticesWithRolename(LinkedList<Edge> inci, String... rolenames) {
     ...
     * @return LinkedList&ltVertex&gt which contains the relevant edges
     */
    private LinkedList<Vertex> getAllVerticesWithRolename(Vertex to, String... rolenames) {
        LinkedList<Vertex> ret = new LinkedList<>();
     ...
     * @param actual
     */
    private void compareLists(List<Vertex> expected, Iterable<? extends Vertex> actual) {
    ...
    private Schema compileSchema(String schemaString) throws GraphIOException {
        ByteArrayInputStream input = new ByteArrayInputStream(schemaString.getBytes());
        Schema s = null;
    ...
    public void eAddTargetrolenameTest0() {
        ...
        testIncidenceList(v2, e1.getReversedEdge(), e2.getReversedEdge(), e4.getReversedEdge());
    ...
    public void eAddTargetrolenameTest1() {
        ...
        E e4 = v1.add_x(v2);
        testIncidenceList(v1, e1, e2, e3, e4);
        testIncidenceList(v2, e1.getReversedEdge(), e2.getReversedEdge(), e3.getReversedEdge(), e4.getReversedEdge());
    }
    ...
    public void eAddTargetrolenameTest2() {
        ...
        testIncidenceList(v2, e2.getReversedEdge(), e3, e3.getReversedEdge(), e4);
    ...
    public void mixedAddTargetrolenameTest0() {
        ...
        testIncidenceList(v4, e2.getReversedEdge(), e3.getReversedEdge(), e4.getReversedEdge(), e5.getReversedEdge(),
                e6.getReversedEdge(), e7.getReversedEdge());
        testIncidenceList(v5, e9.getReversedEdge());
        testIncidenceList(v6, e10.getReversedEdge(), e11.getReversedEdge(), e12.getReversedEdge());
    }
    ...
    public void addTargetrolenameRandomTest0() {
        ...
        createRandomGraph(true, v1, v2, v3, v4, v5, v6, v7, v8, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci,
                v8Inci);
        testIncidences(v1, v2, v3, v4, v5, v6, v7, v8, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci, v8Inci);
        deleteRandomEdges(v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci, v8Inci);
        testIncidences(v1, v2, v3, v4, v5, v6, v7, v8, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci, v8Inci);
        createRandomGraph(true, v1, v2, v3, v4, v5, v6, v7, v8, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci,
                v8Inci);
        testIncidences(v1, v2, v3, v4, v5, v6, v7, v8, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci, v8Inci);
    ...
    public void getRoleNameListRandomTest0() {
        ...
        createRandomGraph(true, v1, v2, v3, v4, v5, v6, v7, v8, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci,
                v8Inci);
        LinkedList<Vertex> expected = getAllVerticesWithRolename(v1Inci, "x", "w");
    ...
    public void addSourcerolenameRandomTest0() {
        ...
        createRandomGraph(false, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v1Inci, v2Inci, v3Inci, v4Inci,
                v5Inci, v6Inci, v7Inci, v8Inci, v9Inci, v10Inci, v11Inci, v12Inci);
        testIncidences(v1, v2, v3, v4, v5, v6, v7, v8, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci, v8Inci);
        deleteRandomEdges(v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci, v8Inci, v9Inci, v10Inci, v11Inci,
                v12Inci);
        testIncidences(v1, v2, v3, v4, v5, v6, v7, v8, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci, v6Inci, v7Inci, v8Inci);
        createRandomGraph(false, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v1Inci, v2Inci, v3Inci, v4Inci,
                v5Inci, v6Inci, v7Inci, v8Inci, v9Inci, v10Inci, v11Inci, v12Inci);
    ...
    public void removeSourcerolenameRandomTest0() {
        ...
        v3.remove_sourceE(v1);
        testIncidences(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v1Inci, v2Inci, v3Inci, v4Inci, v5Inci,
                v6Inci, v7Inci, v8Inci, v9Inci, v10Inci, v11Inci, v12Inci);
    ...
    public void legalRolenamesTest0() throws GraphIOException {
        compileSchema("TGraph 2;" + "Schema de.uni_koblenz.jgralabtest.TestSchema;" + "GraphClass TestGraph;"
                + "VertexClass A;" + "VertexClass B;" + "EdgeClass E from A (0,*) role sourceE to B (0,*) role targetE;"
    ...
    public void legalRolenamesTest2() throws GraphIOException {
        compileSchema("TGraph 2;" + "Schema de.uni_koblenz.jgralabtest.TestSchema;" + "GraphClass TestGraph;"
                + "VertexClass A;" + "VertexClass B;" + "VertexClass C;" + "VertexClass D;"
     ...
     * This test fails, because at vertex A the rolename 'targetE' does not tell, if
     * you have an edge of type E or F.
     */
    @Test(expected = GraphIOException.class)
    public void illegalRolenamesTest3() throws GraphIOException {
        compileSchema("TGraph 2;" + "Schema de.uni_koblenz.jgralabtest.TestSchema;" + "GraphClass TestGraph;"
                + "VertexClass A;" + "VertexClass B;" + "EdgeClass E from A (0,*) to B (0,*) role targetE;"
    ...
    public void illegalRolenamesTest8() throws GraphIOException {
        compileSchema("TGraph 2;" + "Schema de.uni_koblenz.jgralabtest.TestSchema;" + "GraphClass TestGraph;"
                + "VertexClass A;" + "EdgeClass E from A (0,*) role targetE to A (0,*) role targetE;");
    }

    /**
     * targetE A--&gt{E}B:A targetE<br>
     *
     * Source and target rolename are the same and the edge ends at a subvertex of
     * its alpha vertex.
     */
    @Test(expected = GraphIOException.class)
     ...
     * Source and target rolename are the same. Alpha and omega are subclasses of
     * the same vertexclass.
     *
    ...
    public void legalRolenamesTest10() throws GraphIOException {
        compileSchema("TGraph 2;" + "Schema de.uni_koblenz.jgralabtest.TestSchema;" + "GraphClass TestGraph;"
                + "VertexClass A;" + "VertexClass B:A;" + "VertexClass C:A;"
    ...
    public void legalRolenamesTest13() throws GraphIOException {
        compileSchema("TGraph 2;" + "Schema de.uni_koblenz.jgralabtest.TestSchema;" + "GraphClass TestGraph;"
                + "VertexClass A;" + "VertexClass B;" + "VertexClass C:A;" + "VertexClass D:B;"
                + "EdgeClass E from A (0,*) role sourceE to B (0,*) role targetE;"
     ...
     *
     * There can only be one rolename in the inheritance tree of a vertex. In this
     * case B and D.
     */
    @Test(expected = GraphIOException.class)
    ...
    public void legalRolenamesTest17() throws GraphIOException {
        compileSchema("TGraph 2;" + "Schema de.uni_koblenz.jgralabtest.TestSchema;" + "GraphClass TestGraph;"
                + "VertexClass A;" + "VertexClass B;" + "VertexClass C;"
                + "EdgeClass E from A (0,*) role sourceE to B (0,*) role targetE;"
     ...
     *
     * A rolename cannot be defined twice for the same vertex. Remember: A rolename
     * will become a attribute in the opposite vertex
     */
    @Test(expected = GraphIOException.class)
